...
const GridBoldDuotone = memo(
  forwardRef<SVGSVGElement, GridBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="grid-bold-duotone" {...props}>
      <path fillRule="evenodd" d="M10.17 4.5v3.67h3.66V4.5h.27l1.73.01v3.66h3.66l.01 1.73v.27h-3.67v3.66h3.67v.27l-.01 1.73h-3.66v3.66l-1.73.01h-.27v-3.67h-3.66v3.67H9.9l-1.73-.01v-3.66H4.5L4.5 14.1v-.27h3.67v-3.66H4.5V9.9l.01-1.73h3.66V4.5L9.9 4.5zm0 9.33h3.66v-3.66h-3.66z" clipRule="evenodd" opacity={.4} />
