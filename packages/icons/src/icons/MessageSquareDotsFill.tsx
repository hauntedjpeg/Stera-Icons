...
type MessageSquareDotsFillProps = Omit<IconBaseProps, 'children'>;

const MessageSquareDotsFill = memo(
  forwardRef<SVGSVGElement, MessageSquareDotsFillProps>((props, ref) => (
