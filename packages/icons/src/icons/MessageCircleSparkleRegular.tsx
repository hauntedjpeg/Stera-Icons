...
type MessageCircleSparkleRegularProps = Omit<IconBaseProps, 'children'>;

const MessageCircleSparkleRegular = memo(
  forwardRef<SVGSVGElement, MessageCircleSparkleRegularProps>((props, ref) => (
