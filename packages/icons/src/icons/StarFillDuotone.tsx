...
const StarFillDuotone = memo(
  forwardRef<SVGSVGElement, StarFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="star-fill-duotone" {...props}>
      <path d="M13.73 8.7c.22.5.7.85 1.24.9l4.32.4-3.25 2.83c-.42.36-.6.92-.48 1.47l.96 4.2-3.75-2.21-.18-.1q-.59-.22-1.18 0l-.18.1-3.75 2.2.96-4.2a1.5 1.5 0 0 0-.48-1.46L4.7 10l4.32-.4c.54-.05 1.02-.4 1.24-.9L12 4.73z" opacity={.4} />
