...
type MessageSquareDotRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageSquareDotRegularDuotone = memo(
  forwardRef<SVGSVGElement, MessageSquareDotRegularDuotoneProps>((props, ref) => (
