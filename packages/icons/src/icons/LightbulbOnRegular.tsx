...
const LightbulbOnRegular = memo(
  forwardRef<SVGSVGElement, LightbulbOnRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fillRule="evenodd" d="M12 5.78a5.32 5.32 0 0 1 4.43 8.26c-.76 1.15-1.4 2.1-1.4 3.13v1.24c0 1.02-.59 1.9-1.44 2.31a1.66 1.66 0 0 1-3.18 0 2.6 2.6 0 0 1-1.45-2.3v-1.25c0-1.04-.63-1.98-1.4-3.13A5.32 5.32 0 0 1 12 5.78M10.46 18.4c0 .6.49 1.08 1.08 1.08h.92c.6 0 1.07-.48 1.07-1.08v-1.08h-3.07zM12 7.28A3.82 3.82 0 0 0 8.8 13.2c.49.72 1.1 1.61 1.43 2.62h3.52c.32-1.01.94-1.9 1.42-2.62A3.82 3.82 0 0 0 12 7.28" clipRule="evenodd" />
        <path d="M3.33 8.78c.1-.4.52-.64.92-.53l.88.23a.75.75 0 0 1-.39 1.45l-.88-.24a.75.75 0 0 1-.53-.91M19.75 8.25a.75.75 0 0 1 .39 1.44l-.88.24a.75.75 0 0 1-.4-1.45zM5.65 4.75c.3-.29.77-.29 1.06 0l.65.65A.75.75 0 0 1 6.3 6.46l-.65-.65a.75.75 0 0 1 0-1.06M17.29 4.75a.75.75 0 1 1 1.06 1.06l-.65.65a.75.75 0 0 1-1.06-1.06zM9.68 2.43c.4-.1.8.13.91.53l.24.88a.75.75 0 1 1-1.45.39l-.24-.88c-.1-.4.14-.81.54-.92M13.4 2.96a.75.75 0 0 1 1.45.39l-.23.88a.75.75 0 0 1-1.45-.39z" />
    </IconBase>
  ))
);
