...
type MessageCircleDotRegularProps = Omit<IconBaseProps, 'children'>;

const MessageCircleDotRegular = memo(
  forwardRef<SVGSVGElement, MessageCircleDotRegularProps>((props, ref) => (
