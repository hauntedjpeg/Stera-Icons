...
const LayersAltFill = memo(
  forwardRef<SVGSVGElement, LayersAltFillProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M19.6 16.22a.88.88 0 0 1 .8 1.56l-6.22 3.1a4.9 4.9 0 0 1-4.36 0l-6.21-3.1a.87.87 0 0 1 .78-1.56l6.21 3.1c.88.44 1.92.44 2.8 0z" />
        <path d="M19.6 11.72a.88.88 0 0 1 .8 1.56l-6.22 3.1a4.9 4.9 0 0 1-4.36 0l-6.21-3.1a.87.87 0 0 1 .78-1.56l6.21 3.1c.88.44 1.92.44 2.8 0z" />
