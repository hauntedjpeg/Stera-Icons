...
const QrCodeFill = memo(
  forwardRef<SVGSVGElement, QrCodeFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="qr-code-fill" {...props}>
      <path fillRule="evenodd" d="M8.75 13C9.99 13 11 14 11 15.25v4.5C11 20.99 10 22 8.75 22h-4.5C3.01 22 2 21 2 19.75v-4.5C2 14.01 3 13 4.25 13zm-4.5 2a.25.25 0 0 0-.25.25v4.5c0 .14.11.25.25.25h4.5q.23-.02.25-.25v-4.5a.25.25 0 0 0-.25-.25z" clipRule="evenodd" />
