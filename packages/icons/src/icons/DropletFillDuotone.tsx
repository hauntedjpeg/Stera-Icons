...
const DropletFillDuotone = memo(
  forwardRef<SVGSVGElement, DropletFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="droplet-fill-duotone" {...props}>
      <path d="M12.41 4.7c.64.6 1.49 1.44 2.33 2.43s1.67 2.1 2.28 3.25c.62 1.15.98 2.26.98 3.26C18 17.2 15.27 20 12 20s-6-2.8-6-6.36c0-1 .36-2.11.98-3.27a19 19 0 0 1 2.28-3.24A31 31 0 0 1 12 4.33z" opacity={.4} />
