...
type MessageCircleCheckRegularProps = Omit<IconBaseProps, 'children'>;

const MessageCircleCheckRegular = memo(
  forwardRef<SVGSVGElement, MessageCircleCheckRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M14.97 8.22a.75.75 0 0 1 1.06 1.06l-4.31 4.34q-.16.16-.32.3-.15.16-.48.27-.42.12-.84-.06c-.2-.09-.34-.23-.43-.33l-.27-.35-1.48-1.98a.75.75 0 0 1 1.2-.9l1.48 1.99.03.04.04-.04z" />
