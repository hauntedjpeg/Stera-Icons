...
const TextSquareRegular = memo(
  forwardRef<SVGSVGElement, TextSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="text-square" {...props}>
      <path d="M14.92 7.75c.87 0 1.58.7 1.58 1.58a.75.75 0 0 1-1.5 0 .1.1 0 0 0-.08-.08h-1.25c-.5 0-.92.41-.92.92v4.16c0 .51.41.92.92.92a.75.75 0 0 1 0 1.5h-3.34a.75.75 0 0 1 0-1.5c.5 0 .92-.41.92-.92v-4.16c0-.5-.41-.92-.92-.92H9.08a.1.1 0 0 0-.08.08.75.75 0 0 1-1.5 0c0-.87.7-1.58 1.58-1.58z" />
