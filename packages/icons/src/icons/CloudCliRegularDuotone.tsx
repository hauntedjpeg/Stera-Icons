...
type CloudCliRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const CloudCliRegularDuotone = memo(
  forwardRef<SVGSVGElement, CloudCliRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12 4.25a6.8 6.8 0 0 1 6.16 4A5.75 5.75 0 0 1 23.76 14a.75.75 0 0 1-1.5 0 4.25 4.25 0 0 0-4.54-4.24.75.75 0 0 1-.76-.5A5.25 5.25 0 0 0 6.75 11v.11a.75.75 0 0 1-.93.74A3.26 3.26 0 0 0 1.75 15c0 1.8 1.46 3.25 3.25 3.25h3a.75.75 0 0 1 0 1.5H5a4.75 4.75 0 1 1 .3-9.5c.36-3.37 3.22-6 6.7-6" opacity={.4} />
