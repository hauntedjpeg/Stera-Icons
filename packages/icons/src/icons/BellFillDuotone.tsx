...
const BellFillDuotone = memo(
  forwardRef<SVGSVGElement, BellFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12 2.13c3.84 0 6.87 3.25 6.87 7.17v.38c0 1.02.3 2 .87 2.85l.92 1.38a2.88 2.88 0 0 1-2.4 4.47H5.74a2.88 2.88 0 0 1-2.4-4.47l.92-1.38c.57-.85.86-1.83.86-2.85V9.3c0-3.92 3.04-7.17 6.88-7.18" />
