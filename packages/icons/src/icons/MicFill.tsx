...
const MicFill = memo(
  forwardRef<SVGSVGElement, MicFillProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4.03 11.15a.9.9 0 0 1 1.07.63 7.13 7.13 0 0 0 13.8 0 .88.88 0 0 1 1.7.44 8.9 8.9 0 0 1-7.73 6.61v1.3H15a.88.88 0 0 1 0 1.75H9a.88.88 0 0 1 0-1.75h2.12v-1.3a8.9 8.9 0 0 1-7.72-6.61.9.9 0 0 1 .63-1.07" />
