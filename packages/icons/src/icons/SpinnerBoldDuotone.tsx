...
const SpinnerBoldDuotone = memo(
  forwardRef<SVGSVGElement, SpinnerBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.83 15.75a1 1 0 1 1 1.42 1.41l-1.91 1.91a1 1 0 0 1-1.41-1.41zM15.74 15.75a1 1 0 0 1 1.42 0l1.9 1.91a1 1 0 0 1-1.4 1.41l-1.92-1.9a1 1 0 0 1 0-1.42M4.93 4.93a1 1 0 0 1 1.41 0l1.9 1.9a1 1 0 0 1-1.4 1.42l-1.91-1.9a1 1 0 0 1 0-1.42M17.65 4.93a1 1 0 0 1 1.42 1.41l-1.91 1.91a1 1 0 0 1-1.42-1.41z" opacity={0.4} />
