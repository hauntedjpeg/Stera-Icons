...
type MessageSquarePlusBoldProps = Omit<IconBaseProps, 'children'>;

const MessageSquarePlusBold = memo(
  forwardRef<SVGSVGElement, MessageSquarePlusBoldProps>((props, ref) => (
