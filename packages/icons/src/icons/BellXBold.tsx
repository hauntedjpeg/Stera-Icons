...
const BellXBold = memo(
  forwardRef<SVGSVGElement, BellXBoldProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M13.3 7.8a1 1 0 0 1 1.4 1.4l-1.29 1.3 1.3 1.3a1 1 0 1 1-1.42 1.4L12 11.92l-1.3 1.3a1 1 0 1 1-1.4-1.42l1.29-1.29-1.3-1.3a1 1 0 0 1 1.42-1.4L12 9.08z" />
