...
const CodeCircleFillDuotone = memo(
  forwardRef<SVGSVGElement, CodeCircleFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="code-circle-fill-duotone" {...props}>
      <path fillRule="evenodd" d="M12 2.13a9.88 9.88 0 1 1 0 19.75 9.88 9.88 0 0 1 0-19.75m1.21 5.02a.9.9 0 0 0-1.06.64l-2 8a.88.88 0 0 0 1.7.42l2-8a.9.9 0 0 0-.64-1.06m-4.1 2.23a.9.9 0 0 0-1.23 0l-2 2a.9.9 0 0 0 0 1.24l2 2a.88.88 0 0 0 1.24-1.24L7.74 12l1.38-1.38a.9.9 0 0 0 0-1.24m7 0a.88.88 0 0 0-1.23 1.24L16.26 12l-1.38 1.38a.88.88 0 0 0 1.24 1.24l2-2a.9.9 0 0 0 0-1.24z" clipRule="evenodd" opacity={.4} />
