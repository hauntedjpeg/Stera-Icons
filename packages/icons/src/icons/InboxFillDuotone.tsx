...
const InboxFillDuotone = memo(
  forwardRef<SVGSVGElement, InboxFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M16.65 5.38c.46 0 .87.28 1.04.7l2.02 5.05H16a.9.9 0 0 0-.68.32l-.07.1-1.74 2.82H10.5l-1.74-2.83a.9.9 0 0 0-.75-.41H4.3L6.3 6.08c.17-.42.58-.7 1.04-.7z" opacity={.4} />
