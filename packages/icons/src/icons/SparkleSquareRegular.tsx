...
const SparkleSquareRegular = memo(
  forwardRef<SVGSVGElement, SparkleSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11.52 7.1a.5.5 0 0 1 .96 0l.4 1.34a4 4 0 0 0 2.68 2.68l1.34.4c.48.14.48.82 0 .96l-1.34.4a4 4 0 0 0-2.68 2.68l-.4 1.34c-.14.48-.82.48-.96 0l-.4-1.34a4 4 0 0 0-2.68-2.68l-1.34-.4a.5.5 0 0 1 0-.96l1.34-.4a4 4 0 0 0 2.68-2.68z" />
