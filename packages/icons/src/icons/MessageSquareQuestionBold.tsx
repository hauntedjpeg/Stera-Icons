...
type MessageSquareQuestionBoldProps = Omit<IconBaseProps, 'children'>;

const MessageSquareQuestionBold = memo(
  forwardRef<SVGSVGElement, MessageSquareQuestionBoldProps>((props, ref) => (
