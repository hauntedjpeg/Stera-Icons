  ...
  forwardRef<SVGSVGElement, MapPinnedBoldProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M17 12.5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3" />
        <path fillRule="evenodd" d="M17 9c2.78 0 5 2.3 5 5.1 0 .9-.33 1.79-.75 2.55s-.97 1.48-1.5 2.08a19 19 0 0 1-1.93 1.9l-.14.1-.04.04h-.01v.01h-.01a1 1 0 0 1-1.18.05l-.06-.05-.02-.01-.04-.03-.14-.12a18 18 0 0 1-1.93-1.9c-.53-.6-1.08-1.3-1.5-2.07a5.4 5.4 0 0 1-.75-2.56C12 11.3 14.22 9 17 9m0 2c-1.64 0-3 1.36-3 3.1q0 .67.5 1.58c.33.6.78 1.2 1.25 1.73.45.5.9.95 1.25 1.27.35-.32.8-.76 1.25-1.27.47-.54.92-1.13 1.25-1.73q.5-.9.5-1.59c0-1.73-1.36-3.09-3-3.09" clipRule="evenodd" />
