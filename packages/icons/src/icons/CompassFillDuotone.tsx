  ...
  forwardRef<SVGSVGElement, CompassFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12 10.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5" opacity={0.4} />
        ...
        <path fillRule="evenodd" d="M15.72 7.17a.88.88 0 0 1 1.11 1.1l-2 6a.9.9 0 0 1-.55.56l-6 2a.88.88 0 0 1-1.11-1.1l2-6 .04-.1q.17-.34.51-.46zM12 10.75a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5" clipRule="evenodd" />
    </IconBase>
  ))
);
