...
type MessageSquareDashedBoldProps = Omit<IconBaseProps, 'children'>;

const MessageSquareDashedBold = memo(
  forwardRef<SVGSVGElement, MessageSquareDashedBoldProps>((props, ref) => (
