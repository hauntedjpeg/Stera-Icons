...
type CursorBoxBoldProps = Omit<IconBaseProps, 'children'>;

const CursorBoxBold = memo(
  forwardRef<SVGSVGElement, CursorBoxBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="cursor-box-bold" {...props}>
