...
const HomeXBold = memo(
  forwardRef<SVGSVGElement, HomeXBoldProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M13.8 9.54a1 1 0 0 1 1.4 1.42l-1.79 1.79 1.8 1.8a1 1 0 1 1-1.42 1.4L12 14.17l-1.8 1.8a1 1 0 1 1-1.4-1.42l1.79-1.79-1.8-1.8a1 1 0 1 1 1.42-1.4L12 11.33z" />
