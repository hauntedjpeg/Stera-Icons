...
const UserXFillDuotone = memo(
  forwardRef<SVGSVGElement, UserXFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M18.8 15.3a1 1 0 0 1 1.4 1.4L18.92 18l1.3 1.3a1 1 0 0 1-1.42 1.4l-1.29-1.29-1.3 1.3a1 1 0 0 1-1.4-1.42l1.29-1.3-1.3-1.28a1 1 0 0 1 1.42-1.42l1.3 1.3z" />
