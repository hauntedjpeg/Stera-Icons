...
const TrendUpBoldDuotone = memo(
  forwardRef<SVGSVGElement, TrendUpBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M1.79 18.95a1 1 0 0 0 1.41.01l6.54-6.45 2.46 2.43a1 1 0 0 0 1.4 0l6.9-6.8V6.75h-1.44l-6.16 6.08-2.46-2.43a1 1 0 0 0-1.33-.07l-.08.07-7.23 7.14a1 1 0 0 0-.01 1.41" opacity={.4} />
