...
const UserBanRegular = memo(
  forwardRef<SVGSVGElement, UserBanRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="user-ban" {...props}>
      <path fillRule="evenodd" d="M18.5 14.25a4.25 4.25 0 1 1-3.02 1.26l.02-.02.03-.03a4.2 4.2 0 0 1 2.97-1.21m-2.4 2.9q-.34.6-.35 1.35a2.75 2.75 0 0 0 4.1 2.4zm2.4-1.4q-.73.01-1.34.35l3.74 3.74q.34-.6.35-1.34a2.75 2.75 0 0 0-2.75-2.75" clipRule="evenodd" />
