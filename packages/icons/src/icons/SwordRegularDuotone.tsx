...
const SwordRegularDuotone = memo(
  forwardRef<SVGSVGElement, SwordRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="sword-duotone" {...props}>
      <path d="M3.72 3.72a.8.8 0 0 1 .71-.2l3.46.87q.2.05.35.2l8.12 8.11-1.06 1.06L7.33 5.8l-2.05-.5.51 2.04 7.97 7.97-1.06 1.06-8.12-8.12A1 1 0 0 1 4.42 8l-.03-.1-.87-3.46a.8.8 0 0 1 .2-.71" opacity={.4} />
