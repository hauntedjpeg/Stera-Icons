...
type MessageSquareSparkleBoldProps = Omit<IconBaseProps, 'children'>;

const MessageSquareSparkleBold = memo(
  forwardRef<SVGSVGElement, MessageSquareSparkleBoldProps>((props, ref) => (
