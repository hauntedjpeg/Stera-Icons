...
const CoolSBoldDuotone = memo(
  forwardRef<SVGSVGElement, CoolSBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11.52 1.12a1 1 0 0 1 1.1.1l5 4A1 1 0 0 1 18 6v4a1 1 0 0 1-1 1h-1.59l-2-2H16V6.48l-4-3.2-4 3.2v3.1l4.7 4.71a1 1 0 0 1 .3.71v2a1 1 0 1 1-2 0v-1.59l-4.7-4.7A1 1 0 0 1 6 10V6c0-.3.14-.6.38-.78l5-4z" />
