...
const SendVRegularDuotone = memo(
  forwardRef<SVGSVGElement, SendVRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fillRule="evenodd" d="M5.54 21.02a1.89 1.89 0 0 1-2.59-2.5l7.36-14.73a1.89 1.89 0 0 1 3.38 0l7.36 14.73a1.89 1.89 0 0 1-2.59 2.5L12 17.49zM4.3 19.19c-.17.33.2.69.53.5l6.82-3.71c.22-.12.5-.12.72 0l6.82 3.72c.33.18.7-.18.53-.51L12.35 4.46a.39.39 0 0 0-.7 0z" clipRule="evenodd" />
