...
const CurrencyCircleDollarFill = memo(
  forwardRef<SVGSVGElement, CurrencyCircleDollarFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="currency-circle-dollar-fill" {...props}>
      <path fillRule="evenodd" d="M12 2.13a9.88 9.88 0 1 1 0 19.75 9.88 9.88 0 0 1 0-19.75m-.25 3.25c-.48 0-.87.39-.87.87v1.38h-.13a2.63 2.63 0 0 0 0 5.25h3a.88.88 0 0 1 0 1.74H9a.88.88 0 0 0 0 1.76h2.38v1.37a.88.88 0 0 0 1.74 0v-1.37h.63a2.63 2.63 0 0 0 0-5.25h-3a.87.87 0 1 1 0-1.76h3.75a.88.88 0 0 0 0-1.74h-1.87V6.25c0-.48-.4-.87-.88-.87" clipRule="evenodd" />
    </IconBase>
  ))
);
