...
type MessageCircleTextBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageCircleTextBoldDuotone = memo(
  forwardRef<SVGSVGElement, MessageCircleTextBoldDuotoneProps>((props, ref) => (
