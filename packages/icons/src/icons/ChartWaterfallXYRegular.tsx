...
const ChartWaterfallXYRegular = memo(
  forwardRef<SVGSVGElement, ChartWaterfallXYRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chart-waterfall-x-y" {...props}>
      <path d="M2 3.25c.41 0 .75.34.75.75v12.8q0 .84.02 1.25c.03.29.07.43.12.52q.18.35.54.54c.1.05.23.1.52.12s.68.02 1.25.02H22a.75.75 0 0 1 0 1.5H5.2q-.82 0-1.37-.03a3 3 0 0 1-1.08-.27 2.8 2.8 0 0 1-1.2-1.2 3 3 0 0 1-.27-1.08q-.04-.55-.03-1.37V4c0-.41.34-.75.75-.75" />
