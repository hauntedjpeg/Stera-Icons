...
const FlaskFullRegularDuotone = memo(
  forwardRef<SVGSVGElement, FlaskFullRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M14.75 8.98q0 .82.4 1.56l3.9 7.14c1 1.84-.33 4.07-2.42 4.07H7.37a2.75 2.75 0 0 1-2.41-4.07l3.9-7.14q.39-.74.4-1.56V3.75h1.5v5.23q0 1.22-.59 2.27l-3.9 7.15c-.45.83.15 1.85 1.1 1.85h9.26c.95 0 1.55-1.02 1.1-1.85l-3.9-7.15a5 5 0 0 1-.58-2.27V3.75h1.5z" opacity={.4} />
