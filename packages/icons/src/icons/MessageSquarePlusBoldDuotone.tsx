...
type MessageSquarePlusBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageSquarePlusBoldDuotone = memo(
  forwardRef<SVGSVGElement, MessageSquarePlusBoldDuotoneProps>((props, ref) => (
