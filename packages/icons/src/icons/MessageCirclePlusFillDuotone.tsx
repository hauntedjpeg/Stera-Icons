...
type MessageCirclePlusFillDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageCirclePlusFillDuotone = memo(
  forwardRef<SVGSVGElement, MessageCirclePlusFillDuotoneProps>((props, ref) => (
