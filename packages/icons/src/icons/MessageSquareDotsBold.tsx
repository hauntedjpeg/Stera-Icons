...
type MessageSquareDotsBoldProps = Omit<IconBaseProps, 'children'>;

const MessageSquareDotsBold = memo(
  forwardRef<SVGSVGElement, MessageSquareDotsBoldProps>((props, ref) => (
