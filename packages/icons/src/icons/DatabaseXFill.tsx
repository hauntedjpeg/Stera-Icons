...
const DatabaseXFill = memo(
  forwardRef<SVGSVGElement, DatabaseXFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-x-fill" {...props}>
      <path d="M4 13.58q.57.37 1.23.66C7 15.04 9.4 15.5 12 15.5q.96 0 1.88-.08l.08.08-.73.73a2.5 2.5 0 1 0 3.54 3.54l.73-.73.73.73q.32.3.7.48-.69.54-1.62.9c-1.4.54-3.29.85-5.31.85s-3.9-.31-5.31-.86a6 6 0 0 1-1.81-1.05A2.4 2.4 0 0 1 4 18.3z" />
