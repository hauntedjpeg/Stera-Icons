...
const FootballRegular = memo(
  forwardRef<SVGSVGElement, FootballRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="football" {...props}>
      <path d="M13.47 7.47c.3-.3.77-.3 1.06 0l2 2a.75.75 0 0 1-1.06 1.06l-.47-.47L13.06 12l.47.47a.75.75 0 0 1-1.06 1.06l-.47-.47L10.06 15l.47.47a.75.75 0 0 1-1.06 1.06l-2-2a.75.75 0 1 1 1.06-1.06l.47.47L10.94 12l-.47-.47a.75.75 0 0 1 1.06-1.06l.47.47L13.94 9l-.47-.47a.75.75 0 0 1 0-1.06" />
