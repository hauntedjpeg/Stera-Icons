...
const FlowRightArrowBold = memo(
  forwardRef<SVGSVGElement, FlowRightArrowBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="flow-right-arrow-bold" {...props}>
      <path fillRule="evenodd" d="M16.3 6.3a1 1 0 0 1 1.4 0l5 5a1 1 0 0 1 0 1.4l-5 5a1 1 0 1 1-1.4-1.4l3.29-3.3h-8.7a5 5 0 1 1 0-2h8.7l-3.3-3.3a1 1 0 0 1 0-1.4M6 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6" clipRule="evenodd" />
    </IconBase>
  ))
);
