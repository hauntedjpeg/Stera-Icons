...
const AtomOrbitRegular = memo(
  forwardRef<SVGSVGElement, AtomOrbitRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M16.57 18.87a.75.75 0 0 1 .83 1.25 10 10 0 0 1-4.67 1.6h-.02l-.6.03H12l-.71-.03h-.02a9.7 9.7 0 0 1-4.67-1.6.75.75 0 0 1 .83-1.25q.2.14.43.27h.01a8.3 8.3 0 0 0 8.7-.27M3.46 15.2a1.5 1.5 0 1 1 1.5 2.6 1.5 1.5 0 0 1-1.5-2.6M18.5 15.75a1.5 1.5 0 1 1 2.6 1.5 1.5 1.5 0 0 1-2.6-1.5" />
