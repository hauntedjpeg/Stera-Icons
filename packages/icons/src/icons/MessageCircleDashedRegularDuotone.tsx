...
type MessageCircleDashedRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageCircleDashedRegularDuotone = memo(
  forwardRef<SVGSVGElement, MessageCircleDashedRegularDuotoneProps>((props, ref) => (
