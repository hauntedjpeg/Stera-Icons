...
type MessageSquarePlusRegularProps = Omit<IconBaseProps, 'children'>;

const MessageSquarePlusRegular = memo(
  forwardRef<SVGSVGElement, MessageSquarePlusRegularProps>((props, ref) => (
