...
type MessageSquareFillDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageSquareFillDuotone = memo(
  forwardRef<SVGSVGElement, MessageSquareFillDuotoneProps>((props, ref) => (
