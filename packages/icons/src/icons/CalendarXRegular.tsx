...
const CalendarXRegular = memo(
  forwardRef<SVGSVGElement, CalendarXRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="calendar-x" {...props}>
      <path d="M13.47 11.97a.75.75 0 1 1 1.06 1.06l-1.47 1.47 1.47 1.47a.75.75 0 1 1-1.06 1.06L12 15.56l-1.47 1.47a.75.75 0 1 1-1.06-1.06l1.47-1.47-1.47-1.47a.75.75 0 1 1 1.06-1.06L12 13.44z" />
