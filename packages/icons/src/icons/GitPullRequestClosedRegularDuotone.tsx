...
const GitPullRequestClosedRegularDuotone = memo(
  forwardRef<SVGSVGElement, GitPullRequestClosedRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fillRule="evenodd" d="M18.5 10.25c.41 0 .75.34.75.75v4.34a3.25 3.25 0 1 1-1.5 0V11c0-.41.34-.75.75-.75m0 6.5a1.75 1.75 0 1 0 0 3.5 1.75 1.75 0 0 0 0-3.5" clipRule="evenodd" opacity={.4} />
