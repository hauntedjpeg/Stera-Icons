  ...
  forwardRef<SVGSVGElement, GaugeDots0PercentBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="gauge-dots-0-percent-bold-duotone" {...props}>
      <path d="M14.92 14.92a1.37 1.37 0 1 1 1.94 1.94 1.37 1.37 0 0 1-1.94-1.94M6.5 10.63a1.37 1.37 0 1 1 0 2.74 1.37 1.37 0 0 1 0-2.74M17.5 10.63a1.37 1.37 0 1 1 0 2.74 1.37 1.37 0 0 1 0-2.74M7.14 7.14a1.37 1.37 0 1 1 1.94 1.94 1.37 1.37 0 0 1-1.94-1.94M14.92 7.14a1.37 1.37 0 1 1 1.94 1.94 1.37 1.37 0 0 1-1.94-1.94M12 5.13a1.38 1.38 0 1 1 0 2.75 1.38 1.38 0 0 1 0-2.75" opacity={0.4} />
        ...
        <path d="M10.67 10.67a1.88 1.88 0 1 1 2.6 2.7c-.38.34-1.67 1.25-2.8 2.05l-1.54 1.07q-.3.22-.5.34l-.13.1-.04.03-.14.08a.88.88 0 0 1-1.08-1.3l.03-.04.1-.14 1.41-2.03c.8-1.13 1.71-2.41 2.05-2.8z" />
    </IconBase>
  ))
);
