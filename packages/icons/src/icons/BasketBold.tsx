...
const BasketBold = memo(
  forwardRef<SVGSVGElement, BasketBoldProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M7.23 11.54a1 1 0 0 1 1.23.69l1 3.5a1 1 0 0 1-1.92.54l-1-3.5a1 1 0 0 1 .69-1.23M12 11.5a1 1 0 0 1 1 1V16a1 1 0 1 1-2 0v-3.5a1 1 0 0 1 1-1M15.54 12.23a1 1 0 0 1 1.92.54l-1 3.5a1 1 0 0 1-1.92-.54z" />
