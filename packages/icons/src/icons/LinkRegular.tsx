...
const LinkRegular = memo(
  forwardRef<SVGSVGElement, LinkRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11.17 8.77a.75.75 0 0 1 .66 1.35 3.68 3.68 0 0 0-1 5.92l3.13 3.13a3.68 3.68 0 0 0 5.21-5.2l-1.7-1.7a.75.75 0 0 1 1.06-1.07l1.7 1.7a5.18 5.18 0 0 1-7.33 7.33L9.77 17.1a5.18 5.18 0 0 1 1.4-8.33" />
