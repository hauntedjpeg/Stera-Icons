...
type MessageSquareDashedFillProps = Omit<IconBaseProps, 'children'>;

const MessageSquareDashedFill = memo(
  forwardRef<SVGSVGElement, MessageSquareDashedFillProps>((props, ref) => (
