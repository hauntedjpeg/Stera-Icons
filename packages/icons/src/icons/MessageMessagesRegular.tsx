...
type MessageMessagesRegularProps = Omit<IconBaseProps, 'children'>;

const MessageMessagesRegular = memo(
  forwardRef<SVGSVGElement, MessageMessagesRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M19 7.75q.69 0 1.15.02t.9.19c.68.28 1.21.81 1.5 1.49q.16.43.18.9.03.47.02 1.15V21a.75.75 0 0 1-1.15.64l-3.81-2.39H10.5q-.62.01-1.04-.05a2.8 2.8 0 0 1-2.16-2.16q-.06-.41-.05-1.04a.75.75 0 0 1 1.5 0c0 .5 0 .64.02.74.1.5.49.89.99.99.1.02.24.02.74.02H18q.22 0 .4.11l2.85 1.79V11.5q0-.7-.02-1.04a1 1 0 0 0-.07-.44q-.21-.47-.68-.68-.1-.05-.44-.07T19 9.25a.75.75 0 0 1 0-1.5" />
