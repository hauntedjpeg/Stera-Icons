...
const RocketRegular = memo(
  forwardRef<SVGSVGElement, RocketRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M13.5 19.25c.41 0 .75.34.75.75q-.02.49-.27.96A5.4 5.4 0 0 1 12 22.9a5.4 5.4 0 0 1-1.98-1.94 2 2 0 0 1-.27-.96c0-.41.34-.75.75-.75zM12 7.25a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3" />
