...
const LeafFillDuotone = memo(
  forwardRef<SVGSVGElement, LeafFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M20.88 3c0 4.04-.38 6.88-1.2 9.13a15 15 0 0 1-3.75 5.55 7.5 7.5 0 0 1-9.89.63q.36-.46.52-.64l4.14-4.14a.88.88 0 0 0-1.23-1.23l-4.15 4.14q-.22.22-.54.63a7.5 7.5 0 0 1 .54-10 14 14 0 0 1 4.91-3.5c2.22-.91 5.21-1.44 9.77-1.44h.88z" opacity={.4} />
