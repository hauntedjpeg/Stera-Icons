...
type CursorTextSquareBoldProps = Omit<IconBaseProps, 'children'>;

const CursorTextSquareBold = memo(
  forwardRef<SVGSVGElement, CursorTextSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="cursor-text-square-bold" {...props}>
