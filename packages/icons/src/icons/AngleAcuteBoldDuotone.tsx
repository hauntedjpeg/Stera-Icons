...
const AngleAcuteBoldDuotone = memo(
  forwardRef<SVGSVGElement, AngleAcuteBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="angle-acute-bold-duotone" {...props}>
      <path d="M19.59 15.16a1 1 0 0 1 1.15.81v.01a1 1 0 0 1-1.96.35v-.01a1 1 0 0 1 .8-1.16M18.7 12.51a1 1 0 1 1-.6 1.29 1 1 0 0 1 .6-1.29M17.36 10.06a1 1 0 0 1 1.36.36v.01a1 1 0 0 1-1.73 1 1 1 0 0 1 .37-1.37M15.61 7.88a1 1 0 0 1 1.4.12l.08.09a1 1 0 0 1-1.6 1.2 1 1 0 0 1 .12-1.41M13.51 6.03a1 1 0 0 1 1.33-.19l.09.07a1 1 0 0 1-1.29 1.53 1 1 0 0 1-.13-1.41" opacity={0.4} />
