...
const CalendarXFillDuotone = memo(
  forwardRef<SVGSVGElement, CalendarXFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="calendar-x-fill-duotone" {...props}>
      <path fillRule="evenodd" d="M19.12 9.88v3.72c0 1.13 0 1.93-.05 2.56a3 3 0 0 1-.29 1.26q-.46.9-1.36 1.36a3 3 0 0 1-1.26.3c-.63.04-1.43.05-2.56.05h-3.2c-1.13 0-1.93 0-2.56-.06a3 3 0 0 1-1.26-.29 3 3 0 0 1-1.36-1.36 3 3 0 0 1-.3-1.26 35 35 0 0 1-.04-2.56V9.87zm-4.5 2a.9.9 0 0 0-1.24 0L12 13.26l-1.38-1.38a.88.88 0 0 0-1.24 1.24l1.38 1.38-1.38 1.38a.88.88 0 0 0 1.24 1.24L12 15.74l1.38 1.38a.88.88 0 0 0 1.24-1.24l-1.38-1.38 1.38-1.38a.9.9 0 0 0 0-1.24" clipRule="evenodd" opacity={.4} />
