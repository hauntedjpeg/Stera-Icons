...
const ImageStackBoldDuotone = memo(
  forwardRef<SVGSVGElement, ImageStackBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fillRule="evenodd" d="M15.4 2h.05q1.4-.01 2.33.05a5 5 0 0 1 1.76.44 4.5 4.5 0 0 1 1.97 1.97q.38.8.44 1.76.06.94.05 2.38v2.8q.01 1.44-.05 2.38a5 5 0 0 1-.44 1.76 4.5 4.5 0 0 1-1.97 1.97q-.72.36-1.6.43v-.16q.07-.78.06-1.87.42-.06.64-.18a2.5 2.5 0 0 0 1.09-1.1c.1-.2.18-.5.23-1.01.04-.54.04-1.22.04-2.22V8.6c0-1 0-1.68-.04-2.22-.05-.52-.13-.8-.23-1.01a2.5 2.5 0 0 0-1.1-1.1c-.2-.1-.5-.18-1.01-.23C17.08 4 16.4 4 15.4 4h-2.8c-1 0-1.68 0-2.22.04-.52.05-.8.13-1.02.23a2.5 2.5 0 0 0-1.09 1.1q-.12.21-.18.63a25 25 0 0 0-2.03.06q.07-.88.43-1.6a4.5 4.5 0 0 1 1.97-1.97 5 5 0 0 1 1.76-.44Q11.14 2 12.55 2h2.85" clipRule="evenodd" opacity={.4} />
