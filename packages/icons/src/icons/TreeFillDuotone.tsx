  ...
  forwardRef<SVGSVGElement, TreeFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M13 21a1 1 0 1 1-2 0v-2.25h2z" />
        <path d="M12 2.25q.36 0 .6.29l3.88 5a.75.75 0 0 1-.6 1.21h-.8l2.96 3.79a.75.75 0 0 1-.6 1.21h-.8l2.32 2.98c.64.82.06 2.02-.98 2.02H6.02a1.25 1.25 0 0 1-.99-2.02l2.32-2.98h-.8a.75.75 0 0 1-.59-1.21l2.95-3.79h-.8a.75.75 0 0 1-.6-1.21l3.9-5 .05-.07a.8.8 0 0 1 .54-.22" opacity={.4} />
    </IconBase>
  ))
);
