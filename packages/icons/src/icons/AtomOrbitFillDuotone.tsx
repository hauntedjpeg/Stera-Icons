...
const AtomOrbitFillDuotone = memo(
  forwardRef<SVGSVGElement, AtomOrbitFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.18 18.94a1 1 0 0 1 1.39-.28 8 8 0 0 0 8.43.27 1 1 0 0 1 .46-.13l.04-.03a.87.87 0 1 1 .97 1.46l-.1.06a1 1 0 0 1-.37.37 10 10 0 0 1-10.54-.33 1 1 0 0 1-.28-1.39M7.61 3.15a.88.88 0 0 1 .78 1.57l-.05.02a1 1 0 0 1-.34.33 8 8 0 0 0-3.99 7.44 1 1 0 0 1-2 .12A10 10 0 0 1 7 3.34a1 1 0 0 1 .5-.13zM15.22 3.55a.87.87 0 0 1 1.17-.4 10 10 0 0 1 3.93 3.54l.04.05a10 10 0 0 1 1.41 3.83l.05.36q.09.84.04 1.7a.88.88 0 0 1-1.75-.12l.01-.5V12a8.2 8.2 0 0 0-4.06-7.04l-.02-.01-.43-.23a.87.87 0 0 1-.4-1.17" opacity={0.4} />
