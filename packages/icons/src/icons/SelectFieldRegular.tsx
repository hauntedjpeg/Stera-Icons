...
const SelectFieldRegular = memo(
  forwardRef<SVGSVGElement, SelectFieldRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="select-field" {...props}>
      <path d="M18.01 10.68a.75.75 0 0 1 .98 1.14l-1.75 1.5a.75.75 0 0 1-.98 0l-1.75-1.5a.75.75 0 0 1 .98-1.14l1.26 1.08zM11 11.25a.75.75 0 0 1 0 1.5H5.5a.75.75 0 0 1 0-1.5z" />
