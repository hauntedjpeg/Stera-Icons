...
const GitMergeRegularDuotone = memo(
  forwardRef<SVGSVGElement, GitMergeRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="git-merge-duotone" {...props}>
      <path fillRule="evenodd" d="M6.31 8.65a3.25 3.25 0 0 0 3.19 2.6h5.84a3.25 3.25 0 1 1 0 1.5H9.5c-1.26 0-2.4-.5-3.25-1.29v3.88a3.25 3.25 0 1 1-1.5 0V8.66a3 3 0 0 0 1.56-.01m-.81 8.1a1.75 1.75 0 1 0 0 3.5 1.75 1.75 0 0 0 0-3.5m13-6.5a1.75 1.75 0 1 0 0 3.5 1.75 1.75 0 0 0 0-3.5" clipRule="evenodd" opacity={.4} />
