...
type MessageSquarePlusFillDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageSquarePlusFillDuotone = memo(
  forwardRef<SVGSVGElement, MessageSquarePlusFillDuotoneProps>((props, ref) => (
