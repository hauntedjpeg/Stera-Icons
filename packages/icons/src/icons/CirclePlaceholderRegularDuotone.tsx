...
const CirclePlaceholderRegularDuotone = memo(
  forwardRef<SVGSVGElement, CirclePlaceholderRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M13.53 20.1a8 8 0 0 1-2 .13l-7.76-7.77a8 8 0 0 1 .12-1.99zM17.04 18.53a8 8 0 0 1-1.3.82L4.64 8.25a8 8 0 0 1 .83-1.3zM19.35 15.75a8 8 0 0 1-.82 1.3L6.96 5.46a8 8 0 0 1 1.3-.82zM10.83 3.83a8 8 0 0 1 1.63-.06l7.77 7.77a8 8 0 0 1-.12 1.99l-9.64-9.64z" opacity={0.4} />
