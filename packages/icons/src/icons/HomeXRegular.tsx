...
const HomeXRegular = memo(
  forwardRef<SVGSVGElement, HomeXRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="home-x" {...props}>
      <path d="M13.97 9.72a.75.75 0 0 1 1.06 1.06l-1.97 1.97 1.97 1.97a.75.75 0 1 1-1.06 1.06L12 13.81l-1.97 1.97a.75.75 0 1 1-1.06-1.06l1.97-1.97-1.97-1.97a.75.75 0 1 1 1.06-1.06L12 11.69z" />
