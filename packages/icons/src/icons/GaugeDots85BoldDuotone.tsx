...
type GaugeDots85BoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const GaugeDots85BoldDuotone = memo(
  forwardRef<SVGSVGElement, GaugeDots85BoldDuotoneProps>((props, ref) => (
