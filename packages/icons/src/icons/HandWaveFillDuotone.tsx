...
const HandWaveFillDuotone = memo(
  forwardRef<SVGSVGElement, HandWaveFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M10.69 5.42c.35-.2.8-.08 1 .26l2.82 4.87q-.31.29-.63.74c-.28.42-.52.97-.56 1.62a3.7 3.7 0 0 0 .55 2.11.88.88 0 0 0 1.51-.87 2 2 0 0 1-.31-1.12q.04-.44.27-.78a3 3 0 0 1 .75-.72.9.9 0 0 0 .44-.75l.02-2.6q0-.34.27-.56a.73.73 0 0 1 1.2.56v.13l.4 2.64.05.18a5.5 5.5 0 0 1-2.42 6.7 5.56 5.56 0 0 1-7.58-2.02l-2.8-4.84a.7.7 0 0 1 .26-.98c.35-.2.8-.08 1 .26l1.8 3.11a.88.88 0 0 0 1.52-.87l-3-5.19a.7.7 0 0 1 .26-.98c.35-.2.8-.08 1 .26l.4.7 2.4 4.14a.88.88 0 0 0 1.52-.88l-2.4-4.14a.7.7 0 0 1 .26-.98" opacity={.4} />
