  ...
  forwardRef<SVGSVGElement, SendFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M15.38 7.38a.88.88 0 0 1 1.24 1.24l-5.73 5.73-.28-.96-.96-.28z" />
        <path d="m9.65 13.1-6.08-1.78a2.02 2.02 0 0 1-.07-3.85l15.72-5.24a2.02 2.02 0 0 1 2.55 2.55L16.53 20.5a2.02 2.02 0 0 1-3.85-.07l-1.79-6.08 5.73-5.73a.87.87 0 0 0-1.24-1.24z" opacity={.4} />
    </IconBase>
  ))
);
