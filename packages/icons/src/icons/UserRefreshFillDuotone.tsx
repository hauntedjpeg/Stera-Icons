  ...
  forwardRef<SVGSVGElement, UserRefreshFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12 15.58a6.3 6.3 0 0 1 5.17 2.68 8.1 8.1 0 0 1-10.34 0A6.3 6.3 0 0 1 12 15.58M12 8.38a2.73 2.73 0 1 1 0 5.45 2.73 2.73 0 0 1 0-5.45" opacity={0.4} />
        <path fillRule="evenodd" d="M12 6.63A4.48 4.48 0 0 1 15 14.4a8 8 0 0 1 3.4 2.58q.19-.24.36-.5a.88.88 0 0 1 1.46.97 9.87 9.87 0 0 1-18.1-5.35l-.51.5a.88.88 0 0 1-1.24-1.23l1.94-1.94a.96.96 0 0 1 1.35 0l1.95 1.94a.88.88 0 0 1-1.24 1.24l-.5-.5a8 8 0 0 0 1.71 4.87 8 8 0 0 1 3.4-2.58 4.46 4.46 0 0 1 3-7.78m0 8.95a6.3 6.3 0 0 0-5.17 2.68 8.1 8.1 0 0 0 10.34 0A6.3 6.3 0 0 0 12 15.58m0-7.2a2.72 2.72 0 1 0 0 5.44 2.72 2.72 0 0 0 0-5.44" clipRule="evenodd" />
