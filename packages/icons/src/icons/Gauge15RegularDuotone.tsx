...
type Gauge15RegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const Gauge15RegularDuotone = memo(
  forwardRef<SVGSVGElement, Gauge15RegularDuotoneProps>((props, ref) => (
