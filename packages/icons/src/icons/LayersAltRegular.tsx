...
const LayersAltRegular = memo(
  forwardRef<SVGSVGElement, LayersAltRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M19.67 16.33a.75.75 0 0 1 .66 1.34l-6.2 3.1a4.8 4.8 0 0 1-4.25 0l-6.21-3.1a.75.75 0 0 1 .67-1.34l6.2 3.1c.92.46 2 .46 2.91 0z" />
        <path d="M19.67 11.83a.75.75 0 0 1 .66 1.34l-6.2 3.1a4.8 4.8 0 0 1-4.25 0l-6.21-3.1a.75.75 0 0 1 .67-1.34l6.2 3.1c.92.46 2 .46 2.91 0z" />
