...
type CursorBoxRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const CursorBoxRegularDuotone = memo(
  forwardRef<SVGSVGElement, CursorBoxRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="cursor-box-duotone" {...props}>
