...
type MessageSquareQuestionRegularProps = Omit<IconBaseProps, 'children'>;

const MessageSquareQuestionRegular = memo(
  forwardRef<SVGSVGElement, MessageSquareQuestionRegularProps>((props, ref) => (
