...
const CalendarMinusFillDuotone = memo(
  forwardRef<SVGSVGElement, CalendarMinusFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="calendar-minus-fill-duotone" {...props}>
      <path fillRule="evenodd" d="M19 10v3.6c0 1.14 0 1.93-.05 2.55-.05.6-.14.95-.28 1.21a3 3 0 0 1-1.3 1.31 3 3 0 0 1-1.22.28c-.62.05-1.41.05-2.55.05h-3.2c-1.14 0-1.93 0-2.55-.05a3 3 0 0 1-1.21-.28 3 3 0 0 1-1.31-1.3 3 3 0 0 1-.28-1.22C5 15.53 5 14.74 5 13.6V10zm-9.5 3.5a1 1 0 1 0 0 2h5a1 1 0 1 0 0-2z" clipRule="evenodd" opacity={.4} />
