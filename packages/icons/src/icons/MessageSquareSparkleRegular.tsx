...
type MessageSquareSparkleRegularProps = Omit<IconBaseProps, 'children'>;

const MessageSquareSparkleRegular = memo(
  forwardRef<SVGSVGElement, MessageSquareSparkleRegularProps>((props, ref) => (
