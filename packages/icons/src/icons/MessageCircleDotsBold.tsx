...
type MessageCircleDotsBoldProps = Omit<IconBaseProps, 'children'>;

const MessageCircleDotsBold = memo(
  forwardRef<SVGSVGElement, MessageCircleDotsBoldProps>((props, ref) => (
