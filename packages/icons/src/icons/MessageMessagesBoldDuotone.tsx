...
type MessageMessagesBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageMessagesBoldDuotone = memo(
  forwardRef<SVGSVGElement, MessageMessagesBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M19 7.5q.68 0 1.16.02.5.02.99.2a3 3 0 0 1 1.62 1.63q.2.5.2.99.04.47.03 1.16V21a1 1 0 0 1-1.53.85l-3.76-2.35H10.5q-.62.02-1.09-.06a3 3 0 0 1-2.35-2.36Q6.99 16.64 7 16a1 1 0 0 1 2 0c0 .51 0 .62.02.7.08.4.39.7.78.78.08.01.19.02.7.02H18a1 1 0 0 1 .53.15L21 19.2v-7.7c0-.48 0-.79-.02-1.03a1 1 0 0 0-.06-.35 1 1 0 0 0-.54-.54 1 1 0 0 0-.35-.06c-.24-.02-.55-.02-1.03-.02a1 1 0 0 1 0-2" opacity={.4} />
