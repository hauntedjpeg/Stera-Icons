...
type MessageSquareDotRegularProps = Omit<IconBaseProps, 'children'>;

const MessageSquareDotRegular = memo(
  forwardRef<SVGSVGElement, MessageSquareDotRegularProps>((props, ref) => (
