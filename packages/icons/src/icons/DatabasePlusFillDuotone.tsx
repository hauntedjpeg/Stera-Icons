...
const DatabasePlusFillDuotone = memo(
  forwardRef<SVGSVGElement, DatabasePlusFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-plus-fill-duotone" {...props}>
      <path d="M4.13 13.51q.53.34 1.15.62c1.27.56 2.85.96 4.6 1.14A2.24 2.24 0 0 0 12 18.25h1.75V20c0 .68.3 1.29.78 1.7q-1.2.17-2.53.18c-2.01 0-3.87-.32-5.26-.85q-1.07-.4-1.78-1.03c-.46-.42-.83-1-.83-1.7z" opacity={0.4} />
