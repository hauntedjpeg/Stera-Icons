  ...
  forwardRef<SVGSVGElement, BrowserXRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="browser-x-duotone" {...props}>
      <path d="M16 7.25a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1 0-1.5z" opacity={0.4} />
        ...
        <path d="M21.47 13.97a.75.75 0 1 1 1.06 1.06l-2.22 2.22 2.22 2.22a.75.75 0 1 1-1.06 1.06l-2.22-2.22-2.22 2.22a.75.75 0 1 1-1.06-1.06l2.22-2.22-2.22-2.22a.75.75 0 1 1 1.06-1.06l2.22 2.22z" />
    </IconBase>
  ))
);
