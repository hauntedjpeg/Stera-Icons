...
const AtomOrbitBold = memo(
  forwardRef<SVGSVGElement, AtomOrbitBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="atom-orbit-bold" {...props}>
      <path d="M16.43 18.66a1 1 0 0 1 1.1 1.67A10 10 0 0 1 12 22h-.12a10 10 0 0 1-3.9-.85l-.32-.14a10 10 0 0 1-1.2-.68 1 1 0 0 1 1.1-1.67q.21.15.42.26H8a8 8 0 0 0 4.61 1.06A8 8 0 0 0 16 18.93h.01zM3.46 15.2a1.5 1.5 0 1 1 1.5 2.6 1.5 1.5 0 0 1-1.5-2.6M18.5 15.75a1.5 1.5 0 1 1 2.6 1.5 1.5 1.5 0 0 1-2.6-1.5" />
