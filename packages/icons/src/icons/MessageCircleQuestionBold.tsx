...
type MessageCircleQuestionBoldProps = Omit<IconBaseProps, 'children'>;

const MessageCircleQuestionBold = memo(
  forwardRef<SVGSVGElement, MessageCircleQuestionBoldProps>((props, ref) => (
