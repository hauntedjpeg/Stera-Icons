...
const BatteryFullBold = memo(
  forwardRef<SVGSVGElement, BatteryFullBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="battery-full-bold" {...props}>
      <path d="m16.2 8.5.4.01q.18 0 .42.08l.16.07.1.06q.3.2.5.5l.06.1.07.16q.07.24.08.41l.01.41v3.4l-.01.4q0 .24-.15.58a1.5 1.5 0 0 1-1.23.81l-.41.01H5.8l-.4-.01a1.5 1.5 0 0 1-1.38-1.38q-.03-.21-.02-.41v-3.4l.01-.4q0-.24.15-.58l.06-.1q.22-.36.6-.56l.16-.07q.24-.07.41-.08l.41-.01z" />
