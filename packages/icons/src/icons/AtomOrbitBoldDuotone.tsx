...
const AtomOrbitBoldDuotone = memo(
  forwardRef<SVGSVGElement, AtomOrbitBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M16.43 18.66a1 1 0 0 1 1.1 1.67 10 10 0 0 1-5.4 1.67h-.27a10 10 0 0 1-5.4-1.67 1 1 0 0 1 1.1-1.67l.43.26H8a8 8 0 0 0 4.62 1.06A8 8 0 0 0 16 18.93h.01zM7.56 3.04a1 1 0 0 1 .89 1.8l-.43.22-.02.01-.22.13-.04.03A8 8 0 0 0 4 12v.02l.01.49a1 1 0 0 1-2 .12 10 10 0 0 1 1.26-5.51l.07-.13a10 10 0 0 1 4.22-3.95M15.1 3.49a1 1 0 0 1 1.35-.45 10 10 0 0 1 3.97 3.57l.05.07.2.34.05.1.11.19.05.09a10 10 0 0 1 1.1 5.23 1 1 0 0 1-2-.12q.02-.26.02-.5V12a8 8 0 0 0-.9-3.67A8 8 0 0 0 16 5.07l-.02-.01-.42-.23a1 1 0 0 1-.45-1.34" opacity={0.4} />
