...
const DatabasePlusFill = memo(
  forwardRef<SVGSVGElement, DatabasePlusFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-plus-fill" {...props}>
      <path d="M4 13.58q.57.37 1.23.66c1.27.57 2.86.97 4.61 1.15A2.25 2.25 0 0 0 12 18.25h1.75V20c0 .74.36 1.4.92 1.8Q13.4 22 12 22c-2.02 0-3.9-.31-5.31-.86a6 6 0 0 1-1.81-1.05A2.4 2.4 0 0 1 4 18.3z" />
