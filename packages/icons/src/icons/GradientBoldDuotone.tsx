...
const GradientBoldDuotone = memo(
  forwardRef<SVGSVGElement, GradientBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="gradient-bold-duotone" {...props}>
      <path fillRule="evenodd" d="M13.3 2.5q1.85-.02 3.04.06c.8.07 1.51.21 2.16.54a5.5 5.5 0 0 1 2.4 2.4c.33.65.47 1.35.54 2.16q.07 1.19.06 3.04v2.6q.02 1.85-.06 3.04c-.07.8-.21 1.51-.54 2.16a5.5 5.5 0 0 1-2.4 2.4c-.65.33-1.35.47-2.16.54q-1.19.07-3.04.06h-2.6q-1.85.02-3.04-.06a6 6 0 0 1-2.16-.54 5.5 5.5 0 0 1-2.4-2.4 6 6 0 0 1-.54-2.16q-.08-1.19-.06-3.04v-2.6q-.02-1.85.06-3.04c.07-.8.21-1.51.54-2.16a5.5 5.5 0 0 1 2.4-2.4 6 6 0 0 1 2.16-.54q1.19-.08 3.04-.06zm-2.6 2c-1.28 0-2.17 0-2.87.06a4 4 0 0 0-1.42.32 3.5 3.5 0 0 0-1.53 1.53 4 4 0 0 0-.32 1.42c-.06.7-.06 1.6-.06 2.87v2.6c0 1.28 0 2.17.06 2.87s.16 1.1.32 1.42c.34.66.87 1.2 1.53 1.53.32.16.73.27 1.42.32.7.06 1.6.06 2.87.06h2.6c1.28 0 2.17 0 2.87-.06a4 4 0 0 0 1.42-.32 3.5 3.5 0 0 0 1.53-1.53c.16-.32.27-.73.32-1.42.06-.7.06-1.6.06-2.87v-2.6c0-1.28 0-2.17-.06-2.87a4 4 0 0 0-.32-1.42 3.5 3.5 0 0 0-1.53-1.53 4 4 0 0 0-1.42-.32c-.7-.06-1.6-.06-2.87-.06z" clipRule="evenodd" opacity={.4} />
