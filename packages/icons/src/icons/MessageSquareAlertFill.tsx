...
type MessageSquareAlertFillProps = Omit<IconBaseProps, 'children'>;

const MessageSquareAlertFill = memo(
  forwardRef<SVGSVGElement, MessageSquareAlertFillProps>((props, ref) => (
