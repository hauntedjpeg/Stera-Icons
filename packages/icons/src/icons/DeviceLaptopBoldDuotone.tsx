...
const DeviceLaptopBoldDuotone = memo(
  forwardRef<SVGSVGElement, DeviceLaptopBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="device-laptop-bold-duotone" {...props}>
      <path d="m20.5 14.41.18.35 1.2 3a2 2 0 0 1-1.86 2.74H3.98a2 2 0 0 1-1.86-2.74l1.2-3 .18-.35v.09a1 1 0 0 0 1 1h.68l-1.2 3h16.04l-1.2-3h.68a1 1 0 0 0 1-1z" opacity={.4} />
