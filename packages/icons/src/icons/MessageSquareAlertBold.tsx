...
type MessageSquareAlertBoldProps = Omit<IconBaseProps, 'children'>;

const MessageSquareAlertBold = memo(
  forwardRef<SVGSVGElement, MessageSquareAlertBoldProps>((props, ref) => (
