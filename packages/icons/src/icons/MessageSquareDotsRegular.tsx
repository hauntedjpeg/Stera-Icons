...
type MessageSquareDotsRegularProps = Omit<IconBaseProps, 'children'>;

const MessageSquareDotsRegular = memo(
  forwardRef<SVGSVGElement, MessageSquareDotsRegularProps>((props, ref) => (
