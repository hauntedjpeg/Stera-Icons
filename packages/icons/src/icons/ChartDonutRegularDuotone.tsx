...
const ChartDonutRegularDuotone = memo(
  forwardRef<SVGSVGElement, ChartDonutRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11.92 2.25a.75.75 0 0 0-.67.75v.78a8.25 8.25 0 1 0 6.03 14.56l-2.78-2.78a4.35 4.35 0 1 1-3.25-7.84v.68c0 .41.34.75.75.75h-.18a2.85 2.85 0 1 0 2.07 4.99l.13-.12c-.28.27-.3.7-.06 1l.06.06 3.81 3.81c.28.28.71.3 1 .06l.06-.06a9.75 9.75 0 1 1-6.97-16.64" />
