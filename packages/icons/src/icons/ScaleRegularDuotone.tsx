...
const ScaleRegularDuotone = memo(
  forwardRef<SVGSVGElement, ScaleRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M8.7 14.62c.12.32.02.67-.25.87A5.8 5.8 0 0 1 5 16.75c-1.2 0-2.35-.45-3.45-1.26a.75.75 0 0 1-.25-.87L3.9 7.75H5.8l.3-.01zm-5.79-.02q1.1.66 2.09.65 1 .01 2.09-.65L5 9.1zM17.92 7.74l.28.01h1.89l2.61 6.87c.12.32.02.67-.25.87A5.8 5.8 0 0 1 19 16.75c-1.2 0-2.35-.45-3.45-1.26a.75.75 0 0 1-.25-.87zm-1 6.86q1.09.66 2.08.65 1 .01 2.09-.65L19 9.1z" opacity={0.4} />
