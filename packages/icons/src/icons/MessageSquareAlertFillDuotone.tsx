...
type MessageSquareAlertFillDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageSquareAlertFillDuotone = memo(
  forwardRef<SVGSVGElement, MessageSquareAlertFillDuotoneProps>((props, ref) => (
