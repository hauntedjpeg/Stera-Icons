...
const CheckBadgeRegular = memo(
  forwardRef<SVGSVGElement, CheckBadgeRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M14.97 9.22a.75.75 0 0 1 1.06 1.06l-4.27 4.34q-.16.17-.31.3-.16.16-.48.27-.43.12-.84-.05-.3-.15-.43-.33-.15-.15-.28-.34l-1.52-2a.75.75 0 0 1 1.2-.9l1.52 2 .03.04.04-.04z" />
