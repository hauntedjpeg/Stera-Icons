...
const KeyholeBoldDuotone = memo(
  forwardRef<SVGSVGElement, KeyholeBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M18.99 17.74A2.25 2.25 0 0 1 16.98 21H7.02a2.25 2.25 0 0 1-2.01-3.26l2.35-4.7q.3.3.61.56a1 1 0 0 0 1.51-.33L6.8 18.64c-.08.16.04.36.22.36h9.96c.18 0 .3-.2.22-.36l-2.68-5.37a1 1 0 0 0 1.5.33q.33-.26.62-.55z" opacity={.4} />
