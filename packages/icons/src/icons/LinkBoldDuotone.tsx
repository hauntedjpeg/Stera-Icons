...
const LinkBoldDuotone = memo(
  forwardRef<SVGSVGElement, LinkBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11.06 8.54a1 1 0 0 1 .88 1.8 3.43 3.43 0 0 0-.93 5.52l3.13 3.13a3.43 3.43 0 0 0 4.85-4.85l-1.7-1.7a1 1 0 0 1 1.42-1.42l1.7 1.7a5.43 5.43 0 0 1-7.68 7.69l-3.14-3.14a5.43 5.43 0 0 1 1.47-8.73" opacity={.4} />
