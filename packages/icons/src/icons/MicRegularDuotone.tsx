...
const MicRegularDuotone = memo(
  forwardRef<SVGSVGElement, MicRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="mic-duotone" {...props}>
      <path d="M19.02 11.81a.75.75 0 0 1 1.45.38 8.8 8.8 0 0 1-7.72 6.53v1.53H15a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1 0-1.5h2.25v-1.53a8.8 8.8 0 0 1-7.72-6.53.75.75 0 0 1 1.45-.38 7.25 7.25 0 0 0 14.04 0" opacity={.4} />
