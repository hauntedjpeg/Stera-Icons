...
const BrowserPlusRegular = memo(
  forwardRef<SVGSVGElement, BrowserPlusRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="browser-plus" {...props}>
      <path d="M19 13.25c.41 0 .75.34.75.75v2.25H22a.75.75 0 0 1 0 1.5h-2.25V20a.75.75 0 0 1-1.5 0v-2.25H16a.75.75 0 0 1 0-1.5h2.25V14c0-.41.34-.75.75-.75M16 7.25a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1 0-1.5z" />
