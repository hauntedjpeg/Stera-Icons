...
const PhoneOffBoldDuotone = memo(
  forwardRef<SVGSVGElement, PhoneOffBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12 10.54c.7 0 2.03-.06 3.14.1.56.1 1.18.25 1.7.57.55.36 1 .95 1 1.77 0 .3-.04.7-.05.8l.07.03c.2.1.55.22 1.14.37l-.5 1.94a9 9 0 0 1-1.5-.5 2 2 0 0 1-.99-.85 2 2 0 0 1-.22-1.07c.02-.34.04-.42.04-.72 0 0 .03-.01-.08-.08q-.23-.16-.9-.27c-.92-.14-2-.1-2.85-.1-.84 0-1.93-.04-2.84.1q-.69.11-.91.27c-.11.07-.08.08-.08.08 0 .3.02.38.04.72 0 .25 0 .66-.22 1.07-.24.42-.61.67-1 .85a9 9 0 0 1-1.48.5L5 14.18a7 7 0 0 0 1.13-.37q.04 0 .07-.03c0-.1-.04-.5-.04-.8 0-.82.44-1.4 1-1.77.5-.32 1.13-.48 1.69-.56 1.11-.17 2.44-.11 3.14-.11" opacity={.4} />
