...
const ChartBarXYRegularDuotone = memo(
  forwardRef<SVGSVGElement, ChartBarXYRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="chart-bar-x-y-duotone" {...props}>
      <path d="M3 4.25c.41 0 .75.34.75.75v12l.01.76.04.22q.08.15.22.22l.22.04.76.01h16a.75.75 0 0 1 0 1.5H5q-.51 0-.88-.02a2 2 0 0 1-.78-.2 2 2 0 0 1-.87-.87 2 2 0 0 1-.2-.78q-.02-.36-.02-.88V5c0-.41.34-.75.75-.75" opacity={.4} />
