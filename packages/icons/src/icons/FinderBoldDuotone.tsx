...
const FinderBoldDuotone = memo(
  forwardRef<SVGSVGElement, FinderBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M16 2.5A5.5 5.5 0 0 1 21.5 8v8a5.5 5.5 0 0 1-5.5 5.5h-2.12l-.04-.01-.07-.02-.13-.04h-.02l-.1-.05-.02-.01-.08-.06-.02-.01-.07-.06-.02-.01-.02-.02-.06-.07-.01-.02-.06-.08v-.01h-.01v-.01l-.01-.01-.02-.04-.26-.5q-.25-.52-.55-1.51-.17-.57-.32-1.28 1 0 2-.22a14 14 0 0 0 .63 2.04H16a3.5 3.5 0 0 0 3.5-3.5V8A3.5 3.5 0 0 0 16 4.5h-2.33l-.12.32c-.24.58-.56 1.4-.91 2.34a72 72 0 0 0-1.69 4.97q.35.03.67.02.36-.04.46-.1a1 1 0 0 1 1.45.9q0 1.4.13 2.53-.98.24-1.99.2-.09-.72-.11-1.53a7 7 0 0 1-1.74-.16l-.26-.05-.08-.02h-.02a1 1 0 0 1-.74-1.22 63 63 0 0 1 2.05-6.25 119 119 0 0 1 1.2-3.08l.08-.19.02-.05v-.01A1 1 0 0 1 13 2.5z" opacity={.4} />
