...
const KeyholeRegularDuotone = memo(
  forwardRef<SVGSVGElement, KeyholeRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M18.77 17.86a2 2 0 0 1-1.8 2.9H7.03a2 2 0 0 1-1.79-2.9L7.66 13q.22.22.47.4a.75.75 0 0 0 1.13-.25l-2.69 5.38a.5.5 0 0 0 .45.72h9.96a.5.5 0 0 0 .44-.72l-2.68-5.38a.75.75 0 0 0 1.13.26l.47-.41z" opacity={.4} />
