...
type MessageCircleAlertRegularProps = Omit<IconBaseProps, 'children'>;

const MessageCircleAlertRegular = memo(
  forwardRef<SVGSVGElement, MessageCircleAlertRegularProps>((props, ref) => (
