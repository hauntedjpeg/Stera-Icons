...
const CursorNavigationBoldDuotone = memo(
  forwardRef<SVGSVGElement, CursorNavigationBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="m21.11 18.24-4.84-9.69a1 1 0 0 1-1.78.91l4.83 9.67q.05.1.03.16 0 .07-.08.13a.3.3 0 0 1-.14.08q-.05.01-.15-.04l-6.5-3.54a1 1 0 0 0-.96 0l-6.5 3.54a.2.2 0 0 1-.16.04.3.3 0 0 1-.13-.08.3.3 0 0 1-.08-.13q-.01-.06.03-.16l4.84-9.68a1 1 0 0 1-1.8-.88L2.9 18.24a2.25 2.25 0 0 0 3.09 2.98L12 17.93l6.02 3.29a2.25 2.25 0 0 0 3.1-2.98" opacity={.4} />
