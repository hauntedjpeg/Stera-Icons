...
const CheckBadgeBold = memo(
  forwardRef<SVGSVGElement, CheckBadgeBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="check-badge-bold" {...props}>
      <path d="M14.79 9.05a1 1 0 0 1 1.42 1.4l-4.27 4.34q-.16.17-.33.32c-.12.1-.3.25-.57.32q-.51.14-1-.06c-.25-.11-.42-.27-.53-.39-.1-.1-.2-.25-.29-.36l-1.51-2a1 1 0 1 1 1.59-1.2l1.37 1.8z" />
