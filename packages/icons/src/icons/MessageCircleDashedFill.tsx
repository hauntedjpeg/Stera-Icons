...
type MessageCircleDashedFillProps = Omit<IconBaseProps, 'children'>;

const MessageCircleDashedFill = memo(
  forwardRef<SVGSVGElement, MessageCircleDashedFillProps>((props, ref) => (
