...
const IdHRegular = memo(
  forwardRef<SVGSVGElement, IdHRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="id-h" {...props}>
      <path d="M9 8a2.5 2.5 0 0 1 1.67 4.36c.78.36 1.42.96 1.75 1.76a1 1 0 0 1-.92 1.38h-5a1 1 0 0 1-.92-1.38c.33-.8.97-1.4 1.75-1.76A2.49 2.49 0 0 1 9 8M17.5 13.25a.75.75 0 0 1 0 1.5H15a.75.75 0 0 1 0-1.5zM17.5 9.25a.75.75 0 0 1 0 1.5H15a.75.75 0 0 1 0-1.5z" />
