...
const FileCabinetFillDuotone = memo(
  forwardRef<SVGSVGElement, FileCabinetFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M18.13 12.88v3.32c0 .85 0 1.44-.04 1.9s-.1.69-.2.86q-.32.61-.93.93c-.17.1-.41.16-.86.2-.46.03-1.05.04-1.9.04H9.8c-.85 0-1.44 0-1.9-.04s-.69-.1-.86-.2q-.62-.32-.93-.93a2 2 0 0 1-.2-.86c-.03-.46-.04-1.05-.04-1.9v-3.32zm-7.63 1.74a.88.88 0 0 0 0 1.76h3a.88.88 0 0 0 0-1.75zM14.2 3.88c.85 0 1.44 0 1.9.03.45.04.69.1.86.2q.61.32.93.93c.1.17.16.41.2.86.03.46.04 1.05.04 1.9v3.33H5.88V7.8c0-.85 0-1.44.03-1.9.04-.45.1-.69.2-.86q.32-.62.93-.93c.17-.1.41-.16.86-.2.46-.03 1.05-.04 1.9-.04zm-3.7 1.75a.88.88 0 0 0 0 1.75h3a.88.88 0 0 0 0-1.75z" opacity={0.4} />
        <path d="M13.5 14.63a.88.88 0 0 1 0 1.74h-3a.88.88 0 0 1 0-1.75zM13.5 5.63a.88.88 0 0 1 0 1.75h-3a.88.88 0 0 1 0-1.75z" />
        <path fillRule="evenodd" d="M14.2 2.13q1.24-.01 2.04.04c.56.04 1.05.14 1.52.38q1.11.57 1.7 1.7.33.68.37 1.5.06.81.05 2.05v8.4q.01 1.24-.05 2.04a4 4 0 0 1-.38 1.52 4 4 0 0 1-1.7 1.7q-.68.33-1.5.37-.82.06-2.05.05H9.8q-1.24.01-2.04-.05a4 4 0 0 1-1.52-.38 4 4 0 0 1-1.7-1.7 4 4 0 0 1-.37-1.5q-.06-.81-.04-2.05V7.8q-.01-1.24.04-2.04c.04-.56.14-1.05.38-1.52q.57-1.11 1.7-1.7.68-.33 1.5-.37.81-.06 2.05-.04zM5.88 16.2c0 .85 0 1.44.03 1.9.04.45.1.69.2.86q.32.61.93.93c.17.1.41.16.86.2.46.03 1.05.04 1.9.04h4.4c.85 0 1.44 0 1.9-.04s.69-.1.86-.2q.61-.32.93-.93c.1-.17.16-.41.2-.86.03-.46.04-1.05.04-1.9v-3.32H5.88zM9.8 3.88c-.85 0-1.44 0-1.9.03-.45.04-.69.1-.86.2q-.62.32-.93.93c-.1.17-.16.41-.2.86-.03.46-.04 1.05-.04 1.9v3.33h12.26V7.8c0-.85 0-1.44-.04-1.9s-.1-.69-.2-.86q-.32-.62-.93-.93a2 2 0 0 0-.86-.2c-.46-.03-1.05-.04-1.9-.04z" clipRule="evenodd" />
    </IconBase>
  ))
);
