...
type MessageSquareAlertRegularProps = Omit<IconBaseProps, 'children'>;

const MessageSquareAlertRegular = memo(
  forwardRef<SVGSVGElement, MessageSquareAlertRegularProps>((props, ref) => (
