...
const CubeFillDuotone = memo(
  forwardRef<SVGSVGElement, CubeFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M20.1 8.5c.02.27.02.66.02 1.32v4.36c0 1.08 0 1.43-.1 1.72q-.15.44-.46.77c-.2.23-.5.4-1.45.94l-4.2 2.33c-.5.27-.8.44-1.04.55V12.5zM11.57 3.35q.43-.09.86 0a6 6 0 0 1 1.48.7l4.2 2.34 1.06.62L12 11 4.83 7c.22-.14.54-.33 1.06-.62l4.2-2.33a6 6 0 0 1 1.48-.71" opacity={0.4} />
