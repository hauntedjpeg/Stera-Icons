...
const CpuFill = memo(
  forwardRef<SVGSVGElement, CpuFillProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="m13.5 7.63.9.01q.39.03.81.22.62.32.93.93.2.41.22.82.02.38.02.89v3q0 .51-.02.9t-.22.81q-.31.62-.93.93-.42.2-.82.22-.38.02-.89.02h-3q-.51 0-.9-.02a2 2 0 0 1-.81-.22q-.62-.31-.93-.93a2 2 0 0 1-.22-.82q-.02-.38-.01-.89v-3l.01-.9q.03-.4.22-.81.32-.62.93-.93.41-.2.82-.22.38-.02.89-.01z" />
