...
const BellXRegularDuotone = memo(
  forwardRef<SVGSVGElement, BellXRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="bell-x-duotone" {...props}>
      <path d="M13.47 7.97a.75.75 0 1 1 1.06 1.06l-1.47 1.47 1.47 1.47a.75.75 0 1 1-1.06 1.06L12 11.56l-1.47 1.47a.75.75 0 1 1-1.06-1.06l1.47-1.47-1.47-1.47a.75.75 0 1 1 1.06-1.06L12 9.44z" />
