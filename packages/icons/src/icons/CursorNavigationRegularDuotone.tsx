...
const CursorNavigationRegularDuotone = memo(
  forwardRef<SVGSVGElement, CursorNavigationRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="cursor-navigation-duotone" {...props}>
      <path d="M4.45 19.02a.5.5 0 0 0 .69.66l6.5-3.54.09-.04q.32-.12.63.04l6.5 3.54c.43.24.9-.22.69-.66L14.7 9.35a.75.75 0 0 0 1.34-.69l4.84 9.69A2 2 0 0 1 18.14 21L12 17.65 5.86 21a2 2 0 0 1-2.75-2.65l4.84-9.67a.75.75 0 0 0 1.35.65z" opacity={.4} />
