...
const LightbulbOnBold = memo(
  forwardRef<SVGSVGElement, LightbulbOnBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="lightbulb-on-bold" {...props}>
      <path fillRule="evenodd" d="M12 5.38a5.57 5.57 0 0 1 4.64 8.65c-.78 1.17-1.36 2.04-1.36 2.98v1.25c0 1.08-.6 2.01-1.49 2.49a1.91 1.91 0 0 1-3.58 0 2.8 2.8 0 0 1-1.5-2.5v-1.24c0-.94-.57-1.82-1.35-2.98A5.57 5.57 0 0 1 12 5.38m-1.29 12.88c0 .45.37.83.83.83h.92c.45 0 .82-.37.82-.83v-.83h-2.57zM12 7.38a3.57 3.57 0 0 0-2.98 5.54c.45.67 1.05 1.52 1.4 2.51h3.16c.35-.99.95-1.84 1.4-2.51q.57-.86.59-1.97c0-1.98-1.6-3.57-3.57-3.57" clipRule="evenodd" />
