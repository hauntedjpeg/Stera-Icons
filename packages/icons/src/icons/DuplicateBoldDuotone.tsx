...
const DuplicateBoldDuotone = memo(
  forwardRef<SVGSVGElement, DuplicateBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11 2c.88 0 1.47 0 1.98.1a5 5 0 0 1 3.92 3.92c.1.51.1 1.1.1 1.98a1 1 0 0 0-1-1h-1c-.02-.28-.03-.44-.06-.58a3 3 0 0 0-2.36-2.36A10 10 0 0 0 11 4H9.4c-1.14 0-1.93 0-2.55.05-.6.05-.95.14-1.21.28a3 3 0 0 0-1.31 1.3 3 3 0 0 0-.28 1.22C4 7.47 4 8.26 4 9.4V11c0 .98 0 1.32.06 1.59A3 3 0 0 0 7 14.99V16a1 1 0 0 0 1 1c-.88 0-1.47 0-1.98-.1a5 5 0 0 1-3.92-3.92C2 12.47 2 11.88 2 11V9.4q-.02-1.65.06-2.7c.06-.74.18-1.38.48-1.97a5 5 0 0 1 2.19-2.19c.6-.3 1.23-.42 1.96-.48Q7.75 1.98 9.4 2z" opacity={.4} />
