...
const CircleDotsRegularDuotone = memo(
  forwardRef<SVGSVGElement, CircleDotsRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4.57 17.3a1.5 1.5 0 0 1 2.12 0h.01a1.5 1.5 0 1 1-2.12 2.13 1.5 1.5 0 0 1 0-2.13M17.3 17.3a1.5 1.5 0 1 1 2.13 2.12 1.5 1.5 0 1 1-2.12-2.12M4.58 4.57A1.5 1.5 0 0 1 6.7 6.7a1.5 1.5 0 1 1-2.13-2.11M17.3 4.57a1.5 1.5 0 1 1 0 2.13 1.5 1.5 0 0 1 0-2.13" opacity={0.4} />
