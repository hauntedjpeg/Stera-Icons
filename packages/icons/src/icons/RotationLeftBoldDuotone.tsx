...
const RotationLeftBoldDuotone = memo(
  forwardRef<SVGSVGElement, RotationLeftBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="rotation-left-bold-duotone" {...props}>
      <path d="M5.82 6.92a1 1 0 0 1 1.55 1.27A6 6 0 0 0 12 18h.59l-1.3-1.3a1 1 0 0 1 1.42-1.4l3 3a1 1 0 0 1 0 1.4l-3 3a1 1 0 1 1-1.42-1.4l1.3-1.3H12A8 8 0 0 1 5.82 6.92" opacity={.4} />
