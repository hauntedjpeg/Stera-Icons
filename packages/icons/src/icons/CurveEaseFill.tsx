  ...
  forwardRef<SVGSVGElement, CurveEaseFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="curve-ease-fill" {...props}>
      <path d="M19 15a3 3 0 1 1 0 6 3 3 0 0 1 0-6" />
        ...
        <path d="M11.03 17a1 1 0 1 1 0 2H11a1 1 0 1 1 0-2zM14 17a1 1 0 0 1 0 2h-.03a1 1 0 1 1 0-2zM5 3a3 3 0 1 1 0 6 3 3 0 0 1 0-6M10.03 5a1 1 0 1 1 0 2H10a1 1 0 0 1 0-2zM13 5a1 1 0 1 1 0 2h-.03a1 1 0 1 1 0-2z" />
    </IconBase>
  ))
);
