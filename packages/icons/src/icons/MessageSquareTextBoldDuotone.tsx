...
type MessageSquareTextBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageSquareTextBoldDuotone = memo(
  forwardRef<SVGSVGElement, MessageSquareTextBoldDuotoneProps>((props, ref) => (
