...
type MessageSquareTextFillDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageSquareTextFillDuotone = memo(
  forwardRef<SVGSVGElement, MessageSquareTextFillDuotoneProps>((props, ref) => (
