...
const LightbulbOnFillDuotone = memo(
  forwardRef<SVGSVGElement, LightbulbOnFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M3.21 8.74a.87.87 0 0 1 1.07-.61l.88.23a.88.88 0 0 1-.45 1.7l-.88-.24a.87.87 0 0 1-.62-1.08M19.72 8.13a.87.87 0 0 1 .45 1.69l-.88.23a.88.88 0 0 1-.45-1.69zM5.57 4.66a.9.9 0 0 1 1.23 0l.65.65A.87.87 0 1 1 6.2 6.55l-.64-.65a.9.9 0 0 1 0-1.24M17.2 4.66a.88.88 0 0 1 1.24 1.24l-.65.65a.88.88 0 0 1-1.24-1.24zM9.64 2.3a.87.87 0 0 1 1.08.63l.23.88a.88.88 0 0 1-1.69.45l-.23-.88a.9.9 0 0 1 .61-1.07M13.28 2.93a.87.87 0 0 1 1.7.45l-.24.88a.88.88 0 0 1-1.7-.45z" opacity={0.4} />
