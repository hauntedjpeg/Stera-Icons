...
const ChartBarRowDescFillDuotone = memo(
  forwardRef<SVGSVGElement, ChartBarRowDescFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M10.75 16c.69 0 1.25.56 1.25 1.25v2c0 .69-.56 1.25-1.25 1.25H5.88V16zM14.75 9.75c.69 0 1.25.56 1.25 1.25v2c0 .69-.56 1.25-1.25 1.25H5.88v-4.5zM17.75 3.5c.69 0 1.25.56 1.25 1.25v2C19 7.44 18.44 8 17.75 8H5.88V3.5z" opacity={0.4} />
