...
type MessageCircleCheckBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageCircleCheckBoldDuotone = memo(
  forwardRef<SVGSVGElement, MessageCircleCheckBoldDuotoneProps>((props, ref) => (
