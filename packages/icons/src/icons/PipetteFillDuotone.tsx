...
const PipetteFillDuotone = memo(
  forwardRef<SVGSVGElement, PipetteFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="pipette-fill-duotone" {...props}>
      <path d="m14.32 14.53-5.39 5.4a4.95 4.95 0 0 1-5.45 1.05l-.32-.14-.13-.32a4.95 4.95 0 0 1 1.04-5.45l5.4-5.4z" opacity={.4} />
