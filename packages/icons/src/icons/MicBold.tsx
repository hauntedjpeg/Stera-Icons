...
const MicBold = memo(
  forwardRef<SVGSVGElement, MicBoldProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4 11.03a1 1 0 0 1 1.22.72 7 7 0 0 0 13.56 0 1 1 0 0 1 1.94.5 9 9 0 0 1-7.72 6.7V20h2a1 1 0 1 1 0 2H9a1 1 0 0 1 0-2h2v-1.06a9 9 0 0 1-7.72-6.7 1 1 0 0 1 .72-1.2" />
