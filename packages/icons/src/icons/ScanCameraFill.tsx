...
const ScanCameraFill = memo(
  forwardRef<SVGSVGElement, ScanCameraFillProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M3.5 15.13c.48 0 .88.39.88.87v1.75c0 1.04.83 1.88 1.87 1.88H8a.88.88 0 0 1 0 1.75H6.25c-2 0-3.62-1.63-3.62-3.63V16c0-.48.39-.87.87-.87M20.5 15.13c.48 0 .88.39.88.87v1.75c0 2-1.63 3.63-3.63 3.63H16a.88.88 0 0 1 0-1.75h1.75c1.04 0 1.88-.84 1.88-1.88V16c0-.48.39-.87.87-.87" />
        ...
        <path d="M8 2.63a.87.87 0 1 1 0 1.75H6.25c-1.04 0-1.87.83-1.87 1.87V8a.87.87 0 1 1-1.75 0V6.25c0-2 1.62-3.62 3.62-3.62zM17.75 2.63c2 0 3.63 1.62 3.63 3.62V8a.88.88 0 0 1-1.75 0V6.25c0-1.04-.84-1.87-1.88-1.87H16a.88.88 0 0 1 0-1.75z" />
    </IconBase>
  ))
);
