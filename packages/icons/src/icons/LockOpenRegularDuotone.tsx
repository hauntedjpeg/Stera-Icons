...
const LockOpenRegularDuotone = memo(
  forwardRef<SVGSVGElement, LockOpenRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12 2.75c1.5 0 2.84.7 3.7 1.78a.75.75 0 1 1-1.16.94A3.24 3.24 0 0 0 8.75 7.5v1.75a15 15 0 0 0-1.5.1V7.5A4.75 4.75 0 0 1 12 2.75M13.5 15.25a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0" />
