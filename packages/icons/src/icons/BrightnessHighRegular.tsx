...
const BrightnessHighRegular = memo(
  forwardRef<SVGSVGElement, BrightnessHighRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="brightness-high" {...props}>
      <path d="M12 18.75c.4 0 .75.34.75.75V22a.75.75 0 0 1-1.5 0v-2.5c0-.41.33-.75.75-.75M6.16 16.77a.75.75 0 0 1 1.06 1.06L5.46 19.6a.75.75 0 0 1-1.06-1.06zM16.78 16.77c.29-.3.76-.3 1.06 0l1.77 1.77a.75.75 0 0 1-1.07 1.06l-1.76-1.77a.75.75 0 0 1 0-1.06" />
