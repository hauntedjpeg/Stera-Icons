...
const WrenchFillDuotone = memo(
  forwardRef<SVGSVGElement, WrenchFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="wrench-fill-duotone" {...props}>
      <path d="M10.78 5.48a5.5 5.5 0 0 1 4.35-1.58l-2.6 2.58a.9.9 0 0 0-.22.82l.71 3.03c.08.32.33.57.65.65l3.03.71q.47.1.82-.23l2.58-2.59a5.46 5.46 0 0 1-7.35 5.6.9.9 0 0 0-.93.2L6.9 19.62a1.77 1.77 0 0 1-2.5-2.5l4.92-4.93c.24-.24.32-.6.2-.93a5.5 5.5 0 0 1 1.26-5.77" opacity={.4} />
