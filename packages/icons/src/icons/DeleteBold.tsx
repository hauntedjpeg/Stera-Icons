...
const DeleteBold = memo(
  forwardRef<SVGSVGElement, DeleteBoldProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M14.8 8.8a1 1 0 0 1 1.4 1.4L14.42 12l1.8 1.8a1 1 0 1 1-1.42 1.4L13 13.42l-1.8 1.8a1 1 0 0 1-1.4-1.42L11.58 12l-1.8-1.8a1 1 0 0 1 1.42-1.4L13 10.58z" />
