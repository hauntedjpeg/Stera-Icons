...
const NoteFillDuotone = memo(
  forwardRef<SVGSVGElement, NoteFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M13.6 4.88c1.13 0 1.93 0 2.56.05.6.05.98.14 1.26.29q.9.46 1.36 1.36c.15.28.24.65.3 1.26.04.63.05 1.43.05 2.56v1.72H16.2q-.82-.01-1.38.04-.6.03-1.13.28-.83.42-1.25 1.25-.25.54-.28 1.13-.05.55-.04 1.38v2.93H10.4c-1.13 0-1.93 0-2.56-.06a3 3 0 0 1-1.26-.29 3 3 0 0 1-1.36-1.36 3 3 0 0 1-.3-1.26 35 35 0 0 1-.04-2.56v-3.2c0-1.13 0-1.93.05-2.56.05-.6.14-.98.29-1.26q.46-.9 1.36-1.36c.28-.15.65-.24 1.26-.3a35 35 0 0 1 2.56-.04z" opacity={0.4} />
