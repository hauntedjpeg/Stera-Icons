...
type MessageCirclePlusBoldProps = Omit<IconBaseProps, 'children'>;

const MessageCirclePlusBold = memo(
  forwardRef<SVGSVGElement, MessageCirclePlusBoldProps>((props, ref) => (
