...
const VolleyballBoldDuotone = memo(
  forwardRef<SVGSVGElement, VolleyballBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.1 12.04q.5-.02 1.12.07c.55 3.79 2.3 6.15 4.46 7.88l-.3-.01a8 8 0 0 1-3.64-1.2 14 14 0 0 1-2.54-6.63q.4-.1.9-.11M19 8.13c.58 1.05.94 2.24 1 3.52-.97 2.12-2.74 4.15-5.49 5.87a5 5 0 0 1-1-1.74c3.83-2.4 5.27-5.32 5.36-7.88zM7.88 5.14q1.52-.1 2.92.22c1.64.36 3.11 1.1 4.18 1.86a10 10 0 0 1-1.11 1.67 10 10 0 0 0-3.51-1.58 6.6 6.6 0 0 0-5.44.96 8 8 0 0 1 2.96-3.13" opacity={0.4} />
