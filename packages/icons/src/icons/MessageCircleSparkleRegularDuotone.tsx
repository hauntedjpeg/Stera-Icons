...
type MessageCircleSparkleRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageCircleSparkleRegularDuotone = memo(
  forwardRef<SVGSVGElement, MessageCircleSparkleRegularDuotoneProps>((props, ref) => (
