...
type MessageCircleQuestionRegularProps = Omit<IconBaseProps, 'children'>;

const MessageCircleQuestionRegular = memo(
  forwardRef<SVGSVGElement, MessageCircleQuestionRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12 13a1 1 0 1 1 0 2 1 1 0 0 1 0-2M12 7.25c1.2 0 2.25.92 2.25 2.15 0 .87-.53 1.59-1.25 1.93a1 1 0 0 0-.23.16l-.02.03a.75.75 0 0 1-1.5-.02c0-.84.68-1.33 1.1-1.53.26-.12.4-.35.4-.57 0-.31-.29-.65-.75-.65-.42 0-.71.28-.77.53a.75.75 0 1 1-1.46-.32A2.26 2.26 0 0 1 12 7.25" />
