...
type MessageCircleTextBoldProps = Omit<IconBaseProps, 'children'>;

const MessageCircleTextBold = memo(
  forwardRef<SVGSVGElement, MessageCircleTextBoldProps>((props, ref) => (
