...
type MessageSquareTextRegularProps = Omit<IconBaseProps, 'children'>;

const MessageSquareTextRegular = memo(
  forwardRef<SVGSVGElement, MessageSquareTextRegularProps>((props, ref) => (
