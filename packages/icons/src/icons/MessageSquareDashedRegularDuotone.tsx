...
type MessageSquareDashedRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageSquareDashedRegularDuotone = memo(
  forwardRef<SVGSVGElement, MessageSquareDashedRegularDuotoneProps>((props, ref) => (
