...
const CurveEaseFill = memo(
  forwardRef<SVGSVGElement, CurveEaseFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="curve-ease-fill" {...props}>
      <path d="M19 15.13a2.88 2.88 0 1 1 0 5.75 2.88 2.88 0 0 1 0-5.75M11.03 17a1 1 0 1 1 0 2H11a1 1 0 1 1 0-2zM14 17a1 1 0 0 1 0 2h-.03a1 1 0 1 1 0-2z" />
        ...
        <path d="M5 3.13a2.87 2.87 0 1 1 0 5.74 2.87 2.87 0 0 1 0-5.74M10.03 5a1 1 0 1 1 0 2H10a1 1 0 0 1 0-2zM13 5a1 1 0 1 1 0 2h-.03a1 1 0 1 1 0-2z" />
    </IconBase>
  ))
);
