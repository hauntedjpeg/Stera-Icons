...
const CircleDotsBoldDuotone = memo(
  forwardRef<SVGSVGElement, CircleDotsBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="circle-dots-bold-duotone" {...props}>
      <path d="M4.22 16.95a2 2 0 1 1 0 2.84v-.02a2 2 0 0 1 0-2.82M16.95 16.95a2 2 0 1 1 2.83 2.83 2 2 0 0 1-2.83-2.83M4.23 4.22a2 2 0 1 1 2.82 2.83 2 2 0 1 1-2.82-2.83M16.95 4.22a2 2 0 0 1 2.82 0h.01a2 2 0 1 1-2.83 2.83 2 2 0 0 1 0-2.83" opacity={0.4} />
