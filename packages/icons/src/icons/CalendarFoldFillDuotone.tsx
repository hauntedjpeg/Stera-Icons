...
const CalendarFoldFillDuotone = memo(
  forwardRef<SVGSVGElement, CalendarFoldFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="calendar-fold-fill-duotone" {...props}>
      <path d="M19.12 9.88v3.24H17.2q-.82-.01-1.38.04-.6.03-1.13.28-.83.42-1.25 1.25-.25.54-.28 1.13-.05.56-.04 1.38v1.93H10.4c-1.13 0-1.93 0-2.56-.06a3 3 0 0 1-1.26-.29 3 3 0 0 1-1.36-1.36 3 3 0 0 1-.3-1.26 35 35 0 0 1-.04-2.56V9.87z" opacity={0.4} />
