...
const QrCodeFillDuotone = memo(
  forwardRef<SVGSVGElement, QrCodeFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="qr-code-fill-duotone" {...props}>
      <path d="M8.75 13.13c1.17 0 2.13.95 2.13 2.12v4.5c0 1.17-.96 2.13-2.13 2.13h-4.5a2.13 2.13 0 0 1-2.12-2.13v-4.5c0-1.17.95-2.12 2.12-2.12zm-4.5 1.74c-.2 0-.37.17-.37.38v4.5c0 .2.16.38.37.38h4.5c.2 0 .38-.17.38-.38v-4.5c0-.2-.17-.37-.38-.37zM8.75 2.13c1.17 0 2.13.95 2.13 2.12v4.5c0 1.17-.96 2.13-2.13 2.13h-4.5a2.13 2.13 0 0 1-2.12-2.13v-4.5c0-1.17.95-2.12 2.12-2.12zM6.5 5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3M19.75 2.13c1.17 0 2.13.95 2.13 2.12v4.5c0 1.17-.96 2.13-2.13 2.13h-4.5a2.13 2.13 0 0 1-2.12-2.13v-4.5c0-1.17.95-2.12 2.12-2.12zm-4.5 1.75c-.2 0-.37.16-.37.37v4.5c0 .2.16.38.37.38h4.5c.2 0 .38-.17.38-.38v-4.5c0-.2-.17-.37-.38-.37z" opacity={0.4} />
        ...
        <path d="M20.9 13.13c.54 0 .98.43.98.97v.97c0 .54-.44.97-.98.97h-1.94V14.1c0-.54.43-.97.97-.97zM6.5 5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3" />
    </IconBase>
  ))
);
