...
const HashItalicBoldDuotone = memo(
  forwardRef<SVGSVGElement, HashItalicBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M7.98 21.22a1 1 0 0 1-1.96-.44L7.1 16h2.05zM13.98 21.22a1 1 0 0 1-1.96-.44L13.1 16h2.05zM9.58 14H7.53l.89-4h2.05zM15.58 14h-2.05l.9-4h2.04zM10.02 2.78a1 1 0 0 1 1.96.44L10.9 8H8.86zM16.02 2.78a1 1 0 0 1 1.96.44L16.9 8h-2.05z" opacity={0.4} />
