...
const LayersBoldDuotone = memo(
  forwardRef<SVGSVGElement, LayersBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fillRule="evenodd" d="M20.1 10.44a1.75 1.75 0 0 1 0 3.12l-1.36.69 1.37.69a1.75 1.75 0 0 1 0 3.12L14.24 21a5 5 0 0 1-4.48 0L3.9 18.06a1.75 1.75 0 0 1 0-3.12l1.37-.7-1.37-.68a1.75 1.75 0 0 1 0-3.12l1.36-.69 2.24 1.12L5.24 12l5.42 2.71a3 3 0 0 0 2.68 0L18.76 12l-2.26-1.13 2.23-1.12zm-5.86 6.06a5 5 0 0 1-4.48 0L7.5 15.37 5.23 16.5l5.43 2.71a3 3 0 0 0 2.68 0l5.42-2.71-2.26-1.13z" clipRule="evenodd" opacity={.4} />
