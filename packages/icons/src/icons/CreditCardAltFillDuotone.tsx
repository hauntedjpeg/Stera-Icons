  ...
  forwardRef<SVGSVGElement, CreditCardAltFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="credit-card-alt-fill-duotone" {...props}>
      <path fillRule="evenodd" d="M21.88 14.2q.01 1.24-.05 2.04a4 4 0 0 1-.38 1.52 4 4 0 0 1-1.7 1.7q-.68.33-1.5.37-.81.06-2.05.05H7.8q-1.24.01-2.04-.05a4 4 0 0 1-1.52-.38 4 4 0 0 1-1.7-1.7 4 4 0 0 1-.37-1.5q-.06-.82-.04-2.05v-3.82h19.75zM6.24 13.13c-.62 0-1.12.5-1.12 1.12v1.5c0 .62.5 1.13 1.12 1.13h3c.62 0 1.13-.5 1.13-1.13v-1.5c0-.62-.5-1.12-1.13-1.12z" clipRule="evenodd" opacity={0.4} />
        ...
        <path d="M9.25 13.13c.62 0 1.13.5 1.13 1.12v1.5c0 .62-.5 1.13-1.13 1.13h-3c-.62 0-1.12-.5-1.12-1.13v-1.5c0-.62.5-1.12 1.12-1.12zM21.88 10.38H2.13V8.62h19.75z" />
    </IconBase>
  ))
);
