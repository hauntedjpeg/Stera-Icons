...
type MessageSquareSparkleBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageSquareSparkleBoldDuotone = memo(
  forwardRef<SVGSVGElement, MessageSquareSparkleBoldDuotoneProps>((props, ref) => (
