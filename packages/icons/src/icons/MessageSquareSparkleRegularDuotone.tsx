...
type MessageSquareSparkleRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const MessageSquareSparkleRegularDuotone = memo(
  forwardRef<SVGSVGElement, MessageSquareSparkleRegularDuotoneProps>((props, ref) => (
