...
const LotusFillDuotone = memo(
  forwardRef<SVGSVGElement, LotusFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M21.13 10.88V12c0 3.9-3.13 7.06-7.02 7.12l.85-.84.32-.34.04-.04.29-.35.03-.04q.15-.18.28-.37l.01-.02.26-.37.02-.04a9 9 0 0 0 1.32-5.4 7 7 0 0 1 2.47-.43zM4 10.88a7 7 0 0 1 2.47.44 9 9 0 0 0 1.32 5.4l.02.03.25.36.04.06.25.33.06.07.27.33.04.04q.14.17.32.34l.84.84a7.1 7.1 0 0 1-7-7.12v-1.12zM13.72 6.96a7 7 0 0 1 2 3.93 7.1 7.1 0 0 1-2 6.15L12 18.76l-1.72-1.72q-.31-.32-.58-.66a7.1 7.1 0 0 1 .58-9.42L12 5.24zM4.87 4.7c.25-.11.54-.1.78.03l2.89 1.54h-.01l-.05.07a9 9 0 0 0-1.7 3.23A9 9 0 0 0 4 9.13h-.42l.8-3.81.03-.1a1 1 0 0 1 .46-.51M18.35 4.73a.88.88 0 0 1 1.27.59l.8 3.8H20a9 9 0 0 0-2.78.45 9 9 0 0 0-1.7-3.23l-.05-.06v-.01z" opacity={0.4} />
