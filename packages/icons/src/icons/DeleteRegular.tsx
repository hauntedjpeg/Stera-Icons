...
const DeleteRegular = memo(
  forwardRef<SVGSVGElement, DeleteRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="delete" {...props}>
      <path d="M14.97 8.97a.75.75 0 0 1 1.06 1.06L14.06 12l1.97 1.97a.75.75 0 0 1-1.06 1.06L13 13.06l-1.97 1.97a.75.75 0 0 1-1.06-1.06L11.94 12l-1.97-1.97a.75.75 0 1 1 1.06-1.06L13 10.94z" />
