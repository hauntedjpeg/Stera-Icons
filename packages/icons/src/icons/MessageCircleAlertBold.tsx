...
type MessageCircleAlertBoldProps = Omit<IconBaseProps, 'children'>;

const MessageCircleAlertBold = memo(
  forwardRef<SVGSVGElement, MessageCircleAlertBoldProps>((props, ref) => (
