...
const RocketRegularDuotone = memo(
  forwardRef<SVGSVGElement, RocketRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.32 9.62q-.07 1.08.04 2.08L4.8 13.26l.77 5 2.42-1.51.12.22.19.32.05.09.02.02v.01q.24.33.63.34h.21L5.4 20.14a.75.75 0 0 1-1.14-.53l-1-6.5a.8.8 0 0 1 .21-.64zM20.53 12.47q.26.27.21.64l-1 6.5a.75.75 0 0 1-1.14.53l-3.81-2.39H15c.25 0 .49-.13.62-.34h.01l.02-.03.24-.4.12-.23 2.42 1.51.77-5-1.57-1.56q.12-1 .05-2.08zM12 7.25a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3" opacity={0.4} />
        <path d="M13.5 19.25c.41 0 .75.34.75.75v.05l-.04.28q-.05.25-.23.63c-.25.5-.71 1.1-1.56 1.66l-.41.28-.42-.27a4.4 4.4 0 0 1-1.57-1.67 3 3 0 0 1-.27-.94V20c0-.41.34-.75.75-.75z" />
