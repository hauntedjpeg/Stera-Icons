...
type MessageCircleTextRegularProps = Omit<IconBaseProps, 'children'>;

const MessageCircleTextRegular = memo(
  forwardRef<SVGSVGElement, MessageCircleTextRegularProps>((props, ref) => (
