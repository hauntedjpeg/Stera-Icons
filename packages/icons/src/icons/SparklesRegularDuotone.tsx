...
const SparklesRegularDuotone = memo(
  forwardRef<SVGSVGElement, SparklesRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M18.88 1.4c.04-.13.2-.13.24 0l.2.63a4 4 0 0 0 2.65 2.66l.64.19c.12.04.12.2 0 .24l-.64.2a4 4 0 0 0-2.66 2.65l-.19.64a.13.13 0 0 1-.24 0l-.2-.64a4 4 0 0 0-2.65-2.66l-.64-.2a.13.13 0 0 1 0-.23l.64-.2a4 4 0 0 0 2.66-2.65z" opacity={.4} />
