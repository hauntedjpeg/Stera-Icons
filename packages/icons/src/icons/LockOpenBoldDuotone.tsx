...
const LockOpenBoldDuotone = memo(
  forwardRef<SVGSVGElement, LockOpenBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12 13.25a2 2 0 1 1 0 4 2 2 0 0 1 0-4M12 2.5a5 5 0 0 1 3.9 1.88 1 1 0 0 1-1.56 1.25A3 3 0 0 0 9 7.5V9q-.72 0-1.25.04-.38.04-.75.11V7.5a5 5 0 0 1 5-5" />
