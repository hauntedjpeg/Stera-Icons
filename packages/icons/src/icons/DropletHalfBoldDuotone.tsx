...
type DropletHalfBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const DropletHalfBoldDuotone = memo(
  forwardRef<SVGSVGElement, DropletHalfBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12.41 4.7c.64.6 1.49 1.44 2.33 2.43s1.67 2.1 2.28 3.25c.62 1.15.98 2.26.98 3.26C18 17.2 15.27 20 12 20V4.33z" opacity={.4} />
