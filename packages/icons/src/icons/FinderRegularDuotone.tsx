...
const FinderRegularDuotone = memo(
  forwardRef<SVGSVGElement, FinderRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M16 2.75c2.9 0 5.25 2.35 5.25 5.25v8c0 2.9-2.35 5.25-5.25 5.25h-2a.8.8 0 0 1-.58-.28l-.06-.07v-.02l-.03-.03a3 3 0 0 1-.24-.49q-.24-.5-.55-1.48-.18-.62-.35-1.45.75-.02 1.5-.16.14.68.3 1.19.27.86.46 1.28v.01H16A3.75 3.75 0 0 0 19.75 16V8A3.75 3.75 0 0 0 16 4.25h-2.5l-.19.47c-.23.59-.56 1.41-.9 2.35a69 69 0 0 0-1.78 5.28l.2.03q.42.03.8.02.4-.03.56-.13a.75.75 0 0 1 1.09.67q.01 1.62.17 2.84-.75.15-1.5.15-.11-.93-.16-2.04h-.05a6 6 0 0 1-1.88-.14l-.25-.05-.07-.02h-.02a.75.75 0 0 1-.55-.92A63 63 0 0 1 11 6.54a119 119 0 0 1 1.2-3.07l.08-.2.02-.04v-.01a.8.8 0 0 1 .7-.47z" opacity={.4} />
